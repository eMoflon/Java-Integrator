...
entryRuleSimplePackage returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSimplePackageRule()); }
	iv_ruleSimplePackage=ruleSimplePackage
	{ $current=$iv_ruleSimplePackage.current; }
	EOF;

// Rule SimplePackage
ruleSimplePackage returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleSimpleParam returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getSimpleParamRule()); }
	iv_ruleSimpleParam=ruleSimpleParam
	{ $current=$iv_ruleSimpleParam.current; }
	EOF;

// Rule SimpleParam
ruleSimpleParam returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleAccess returns [String current=null]:
	{ newCompositeNode(grammarAccess.getAccessRule()); }
	iv_ruleAccess=ruleAccess
	{ $current=$iv_ruleAccess.current.getText(); }
	EOF;

// Rule Access
ruleAccess returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()]
@init {
	enterRule();
}
@after {
