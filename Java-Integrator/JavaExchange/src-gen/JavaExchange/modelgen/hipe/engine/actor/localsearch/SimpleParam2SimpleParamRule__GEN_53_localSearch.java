...
public class SimpleParam2SimpleParamRule__GEN_53_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleParam2SimpleParamRule__GEN_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimpleMethod2SimpleMethod_object": 
				{
					...
					// SM2SM
					HMatch match_0 = new LocalSearchMatch("SimpleParam2SimpleParamRule__GEN_53_localSearch", 3);
			...
			case "SimpleMethod_object": 
				{
					...
					// srcMethod
					HMatch match_1 = new LocalSearchMatch("SimpleParam2SimpleParamRule__GEN_53_localSearch", 3);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// trgMethod
					HMatch match_2 = new LocalSearchMatch("SimpleParam2SimpleParamRule__GEN_53_localSearch", 3);
		...
		case "SimpleMethod2SimpleMethod_target_SimpleMethod": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleParam2SimpleParamRule__GEN_53_localSearch", 3);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
