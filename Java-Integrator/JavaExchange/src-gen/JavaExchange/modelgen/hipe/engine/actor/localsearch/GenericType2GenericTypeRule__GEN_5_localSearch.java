...
public class GenericType2GenericTypeRule__GEN_5_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("GenericType2GenericTypeRule__GEN_production"), this::returnTrue , 0  , false ));
	}
			...
			case "TypeRef2TypeRef_object": 
				{
					...
					// a2a
					HMatch match_0 = new LocalSearchMatch("GenericType2GenericTypeRule__GEN_5_localSearch", 3);
			...
			case "JvmParameterizedTypeReference_object_SP0": 
				{
					...
					// srcRef
					HMatch match_1 = new LocalSearchMatch("GenericType2GenericTypeRule__GEN_5_localSearch", 3);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("GenericType2GenericTypeRule__GEN_5_localSearch", 3);
		...
		case "TypeRef2TypeRef_target_JvmParameterizedTypeReference": 
			{
				...
				HMatch match = new LocalSearchMatch("GenericType2GenericTypeRule__GEN_5_localSearch", 3);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
