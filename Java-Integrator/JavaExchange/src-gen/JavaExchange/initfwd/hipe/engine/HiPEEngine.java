package JavaExchange.initfwd.hipe.engine;
...
import JavaExchange.initfwd.hipe.engine.actor.NotificationActor;
import JavaExchange.initfwd.hipe.engine.actor.DispatchActor;
import JavaExchange.initfwd.hipe.engine.actor.localsearch.FieldType2FieldTypeRule__FWD_1_localSearch;
import JavaExchange.initfwd.hipe.engine.actor.localsearch.GenericType2GenericTypeRule__FWD_6_localSearch;
import JavaExchange.initfwd.hipe.engine.actor.localsearch.ParamType2ParamTypeRule__FWD_11_localSearch;
import JavaExchange.initfwd.hipe.engine.actor.localsearch.PrimitiveType2PrimitiveTypeRule__FWD_16_localSearch;
import JavaExchange.initfwd.hipe.engine.actor.localsearch.SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch;
import JavaExchange.initfwd.hipe.engine.actor.localsearch.SimpleClass2SimpleClassRule__FWD_31_localSearch;
import JavaExchange.initfwd.hipe.engine.actor.localsearch.SimpleField2SimpleFieldRule__FWD_36_localSearch;
import JavaExchange.initfwd.hipe.engine.actor.localsearch.SimpleMethod2SimpleMethodRule__FWD_41_localSearch;
import JavaExchange.initfwd.hipe.engine.actor.localsearch.SimpleParam2SimpleParamRule__FWD_47_localSearch;
...
public class HiPEEngine implements IHiPEEngine{
	...
	public void createJunctionNodes() {
		classes.put("FieldType2FieldTypeRule__FWD_1_localSearch", FieldType2FieldTypeRule__FWD_1_localSearch.class);
		classes.put("GenericType2GenericTypeRule__FWD_6_localSearch", GenericType2GenericTypeRule__FWD_6_localSearch.class);
		classes.put("ParamType2ParamTypeRule__FWD_11_localSearch", ParamType2ParamTypeRule__FWD_11_localSearch.class);
		classes.put("PrimitiveType2PrimitiveTypeRule__FWD_16_localSearch", PrimitiveType2PrimitiveTypeRule__FWD_16_localSearch.class);
		classes.put("SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch", SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch.class);
		classes.put("SimpleClass2SimpleClassRule__FWD_31_localSearch", SimpleClass2SimpleClassRule__FWD_31_localSearch.class);
		classes.put("SimpleField2SimpleFieldRule__FWD_36_localSearch", SimpleField2SimpleFieldRule__FWD_36_localSearch.class);
		classes.put("SimpleMethod2SimpleMethodRule__FWD_41_localSearch", SimpleMethod2SimpleMethodRule__FWD_41_localSearch.class);
		classes.put("SimpleParam2SimpleParamRule__FWD_47_localSearch", SimpleParam2SimpleParamRule__FWD_47_localSearch.class);
	}
