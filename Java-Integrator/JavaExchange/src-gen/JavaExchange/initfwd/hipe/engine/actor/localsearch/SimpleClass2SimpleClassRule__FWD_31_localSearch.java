...
public class SimpleClass2SimpleClassRule__FWD_31_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.SimplePackage2SimplePackage) o).getTarget();
						edge_explorer_3 = new CachedEdgeExplorer(this, 0, 2, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimplePackage2SimplePackage) o).getSource();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleClass2SimpleClassRule__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimplePackage2SimplePackage_object": 
				{
					...
					// SP2SP
					HMatch match_0 = new LocalSearchMatch("SimpleClass2SimpleClassRule__FWD_31_localSearch", 4);
			...
			case "SimplePackage_object": 
				{
					...
					// srcPackage
					HMatch match_1 = new LocalSearchMatch("SimpleClass2SimpleClassRule__FWD_31_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_1_orchestration, match_1);
					
					// trgPackage
					HMatch match_2 = new LocalSearchMatch("SimpleClass2SimpleClassRule__FWD_31_localSearch", 4);
			...
			case "SimpleClass_object": 
				{
					...
					// srcClass
					HMatch match_3 = new LocalSearchMatch("SimpleClass2SimpleClassRule__FWD_31_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "SimplePackage_simpleClasses_SimpleClass": 
			{
				HMatch match = new LocalSearchMatch("SimpleClass2SimpleClassRule__FWD_31_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
