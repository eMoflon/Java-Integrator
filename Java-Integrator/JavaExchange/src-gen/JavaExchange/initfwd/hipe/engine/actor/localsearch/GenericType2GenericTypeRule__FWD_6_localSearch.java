...
public class GenericType2GenericTypeRule__FWD_6_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("GenericType2GenericTypeRule__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "TypeRef2TypeRef_object": 
				{
					...
					// a2a
					HMatch match_0 = new LocalSearchMatch("GenericType2GenericTypeRule__FWD_6_localSearch", 4);
			...
			case "JvmParameterizedTypeReference_object_SP1": 
				{
					...
					// srcRef
					HMatch match_1 = new LocalSearchMatch("GenericType2GenericTypeRule__FWD_6_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_1_orchestration, match_1);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("GenericType2GenericTypeRule__FWD_6_localSearch", 4);
			...
			case "JvmGenericType_object": 
				{
					...
					// srcType
					HMatch match_3 = new LocalSearchMatch("GenericType2GenericTypeRule__FWD_6_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "JvmParameterizedTypeReference_type_JvmType": 
			if(msg.target instanceof org.eclipse.xtext.common.types.JvmGenericType) {
			{
				...
				HMatch match = new LocalSearchMatch("GenericType2GenericTypeRule__FWD_6_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
