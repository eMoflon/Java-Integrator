package JavaExchange.initfwd.hipe.engine.actor.localsearch;
...
public class SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 8, edge_explorer_3_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.Type2Type) o).getTarget();
						edge_explorer_6 = new CachedEdgeExplorer(this, 0, 8, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new CachedEdgeExplorer(this, 4, 5, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.Type2Type) o).getSource();
						edge_explorer_10 = new CachedEdgeExplorer(this, 0, 5, edge_explorer_10_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SecondTypeRef2SecondTypeRefRule__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Type2Type_object": 
				{
					...
					// T2T
					HMatch match_0 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch", 9);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_6_1_orchestration, match_0);
				}
				break;
			case "TypeRef2TypeRef_object": 
				{
					edge_explorer_5.registerSourceObject(objs[0]);
					edge_explorer_8.registerSourceObject(objs[0]);
					
					// TR2TR
					HMatch match_1 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch", 9);
					...
					// TR2TR2
					HMatch match_2 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch", 9);
			...
			case "JvmParameterizedTypeReference_object_SP0": 
				{
					...
					// srcRef
					HMatch match_3 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch", 9);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_5_2_orchestration, match_3);
					edge_explorer_9.registerSourceObject(objs[0]);
					
					// srcRef2
					HMatch match_4 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch", 9);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_4_1_orchestration, match_4);
					edge_explorer_3.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_6 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch", 9);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
					
					// trgRef2
					HMatch match_7 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch", 9);
			...
			case "JvmType_object": 
				{
					...
					// srcType
					HMatch match_5 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch", 9);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_7_1_orchestration, match_5);
					
					// trgType
					HMatch match_8 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch", 9);
		...
		case "TypeRef2TypeRef_target_JvmParameterizedTypeReference": 
			{
				...
				HMatch match = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_21_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[7] = msg.target;
				currentDepth++;
