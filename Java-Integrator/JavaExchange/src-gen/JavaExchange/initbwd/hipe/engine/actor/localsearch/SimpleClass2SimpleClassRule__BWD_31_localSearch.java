...
public class SimpleClass2SimpleClassRule__BWD_31_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleClass2SimpleClassRule__BWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimplePackage2SimplePackage_object": 
				{
					...
					// SP2SP
					HMatch match_0 = new LocalSearchMatch("SimpleClass2SimpleClassRule__BWD_31_localSearch", 4);
			...
			case "SimplePackage_object": 
				{
					...
					// srcPackage
					HMatch match_1 = new LocalSearchMatch("SimpleClass2SimpleClassRule__BWD_31_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgPackage
					HMatch match_2 = new LocalSearchMatch("SimpleClass2SimpleClassRule__BWD_31_localSearch", 4);
			...
			case "SimpleClass_object": 
				{
					...
					// trgClass
					HMatch match_3 = new LocalSearchMatch("SimpleClass2SimpleClassRule__BWD_31_localSearch", 4);
		...
		case "SimplePackage2SimplePackage_source_SimplePackage": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleClass2SimpleClassRule__BWD_31_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
