...
public class SimpleParam2SimpleParamRule__BWD_47_localSearch extends GenericLocalSearchActor{
			...
			case "SimpleMethod2SimpleMethod_object": 
				{
					...
					// SM2SM
					HMatch match_0 = new LocalSearchMatch("SimpleParam2SimpleParamRule__BWD_47_localSearch", 4);
			...
			case "SimpleMethod_object": 
				{
					...
					// srcMethod
					HMatch match_1 = new LocalSearchMatch("SimpleParam2SimpleParamRule__BWD_47_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_4_1_orchestration, match_1);
					
					// trgMethod
					HMatch match_2 = new LocalSearchMatch("SimpleParam2SimpleParamRule__BWD_47_localSearch", 4);
			...
			case "SimpleParam_object": 
				{
					...
					// trgParam
					HMatch match_3 = new LocalSearchMatch("SimpleParam2SimpleParamRule__BWD_47_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "SimpleMethod_params_SimpleParam": 
			{
				HMatch match = new LocalSearchMatch("SimpleParam2SimpleParamRule__BWD_47_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
