...
public class GenericType2GenericTypeRule__BWD_6_localSearch extends GenericLocalSearchActor{
			...
			case "TypeRef2TypeRef_object": 
				{
					...
					// a2a
					HMatch match_0 = new LocalSearchMatch("GenericType2GenericTypeRule__BWD_6_localSearch", 4);
			...
			case "JvmParameterizedTypeReference_object_SP1": 
				{
					...
					// srcRef
					HMatch match_1 = new LocalSearchMatch("GenericType2GenericTypeRule__BWD_6_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					edge_explorer_4.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("GenericType2GenericTypeRule__BWD_6_localSearch", 4);
			...
			case "JvmGenericType_object": 
				{
					...
					// trgType
					HMatch match_3 = new LocalSearchMatch("GenericType2GenericTypeRule__BWD_6_localSearch", 4);
		...
		case "TypeRef2TypeRef_source_JvmParameterizedTypeReference": 
			{
				...
				HMatch match = new LocalSearchMatch("GenericType2GenericTypeRule__BWD_6_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
