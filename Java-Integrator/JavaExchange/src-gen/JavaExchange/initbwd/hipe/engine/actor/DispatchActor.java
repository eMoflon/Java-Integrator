package JavaExchange.initbwd.hipe.engine.actor;
...
public class DispatchActor extends AbstractActor {
	...
	private void initializeAddEdge() {
		...
		feature2addEdgeConsumer.put(org.eclipse.xtext.common.types.impl.TypesPackageImpl.eINSTANCE.getJvmParameterizedTypeReference_Type(), notification -> {
			incUtil.newMessage();
			name2actor.get("GenericType2GenericTypeRule__BWD_6_localSearch").tell(new ReferenceAdded<org.eclipse.xtext.common.types.JvmParameterizedTypeReference, org.eclipse.xtext.common.types.JvmType>(incUtil,(org.eclipse.xtext.common.types.JvmParameterizedTypeReference) notification.getNotifier(), (org.eclipse.xtext.common.types.JvmType) notification.getNewValue(), "JvmParameterizedTypeReference_type_JvmType"), getSelf());
			incUtil.newMessage();
			name2actor.get("PrimitiveType2PrimitiveTypeRule__BWD_16_localSearch").tell(new ReferenceAdded<org.eclipse.xtext.common.types.JvmParameterizedTypeReference, org.eclipse.xtext.common.types.JvmType>(incUtil,(org.eclipse.xtext.common.types.JvmParameterizedTypeReference) notification.getNotifier(), (org.eclipse.xtext.common.types.JvmType) notification.getNewValue(), "JvmParameterizedTypeReference_type_JvmType"), getSelf());
			incUtil.newMessage();
			name2actor.get("SecondTypeRef2SecondTypeRefRule__BWD_21_localSearch").tell(new ReferenceAdded<org.eclipse.xtext.common.types.JvmParameterizedTypeReference, org.eclipse.xtext.common.types.JvmType>(incUtil,(org.eclipse.xtext.common.types.JvmParameterizedTypeReference) notification.getNotifier(), (org.eclipse.xtext.common.types.JvmType) notification.getNewValue(), "JvmParameterizedTypeReference_type_JvmType"), getSelf());
			incUtil.newMessage();
			name2actor.get("SecondTypeRef2SecondTypeRefRule__BWD_21_localSearch").tell(new ReferenceAdded<org.eclipse.xtext.common.types.JvmParameterizedTypeReference, org.eclipse.xtext.common.types.JvmType>(incUtil,(org.eclipse.xtext.common.types.JvmParameterizedTypeReference) notification.getNotifier(), (org.eclipse.xtext.common.types.JvmType) notification.getNewValue(), "JvmParameterizedTypeReference_type_JvmType"), getSelf());
			incUtil.newMessage();
			name2actor.get("SecondTypeRef2SecondTypeRefRule__BWD_21_localSearch").tell(new ReferenceAdded<org.eclipse.xtext.common.types.JvmParameterizedTypeReference, org.eclipse.xtext.common.types.JvmType>(incUtil,(org.eclipse.xtext.common.types.JvmParameterizedTypeReference) notification.getNotifier(), (org.eclipse.xtext.common.types.JvmType) notification.getNewValue(), "JvmParameterizedTypeReference_type_JvmType"), getSelf());
		...
		feature2addEdgeConsumer.put(JavaExchange.JavaExchangePackage.eINSTANCE.getTypeRef2TypeRef_Target(), notification -> {
			incUtil.newMessage();
			name2actor.get("GenericType2GenericTypeRule__BWD_6_localSearch").tell(new ReferenceAdded<JavaExchange.TypeRef2TypeRef, org.eclipse.xtext.common.types.JvmParameterizedTypeReference>(incUtil,(JavaExchange.TypeRef2TypeRef) notification.getNotifier(), (org.eclipse.xtext.common.types.JvmParameterizedTypeReference) notification.getNewValue(), "TypeRef2TypeRef_target_JvmParameterizedTypeReference"), getSelf());
			incUtil.newMessage();
			name2actor.get("PrimitiveType2PrimitiveTypeRule__BWD_16_localSearch").tell(new ReferenceAdded<JavaExchange.TypeRef2TypeRef, org.eclipse.xtext.common.types.JvmParameterizedTypeReference>(incUtil,(JavaExchange.TypeRef2TypeRef) notification.getNotifier(), (org.eclipse.xtext.common.types.JvmParameterizedTypeReference) notification.getNewValue(), "TypeRef2TypeRef_target_JvmParameterizedTypeReference"), getSelf());
			incUtil.newMessage();
	...
	private void initializeRemoveEdge() {
		...
		feature2removeEdgeConsumer.put(org.xtext.simplejava.simpleJava.SimpleJavaPackage.eINSTANCE.getSimpleClass_SimpleFields(), notification -> {
			incUtil.newMessage();
			name2actor.get("SimpleField2SimpleFieldRule__BWD_36_localSearch").tell(new ReferenceDeleted<org.xtext.simplejava.simpleJava.SimpleClass, org.xtext.simplejava.simpleJava.SimpleField>(incUtil, (org.xtext.simplejava.simpleJava.SimpleClass) notification.getNotifier(), (org.xtext.simplejava.simpleJava.SimpleField) notification.getOldValue(), "SimpleClass_simpleFields_SimpleField"), getSelf());
		});
		...
		feature2removeEdgeConsumer.put(org.xtext.simplejava.simpleJava.SimpleJavaPackage.eINSTANCE.getSimpleClass_SimpleMethods(), notification -> {
			incUtil.newMessage();
			name2actor.get("SimpleMethod2SimpleMethodRule__BWD_41_localSearch").tell(new ReferenceDeleted<org.xtext.simplejava.simpleJava.SimpleClass, org.xtext.simplejava.simpleJava.SimpleMethod>(incUtil, (org.xtext.simplejava.simpleJava.SimpleClass) notification.getNotifier(), (org.xtext.simplejava.simpleJava.SimpleMethod) notification.getOldValue(), "SimpleClass_simpleMethods_SimpleMethod"), getSelf());
		});
