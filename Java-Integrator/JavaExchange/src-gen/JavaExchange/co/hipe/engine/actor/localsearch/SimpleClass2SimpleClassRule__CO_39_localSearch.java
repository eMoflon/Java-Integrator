...
public class SimpleClass2SimpleClassRule__CO_39_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimplePackage) o).getSimpleClasses();
						edge_explorer_3_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimplePackage) return edge_explorer_3_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_3 = new EdgeExplorer(this, 2, 5, edge_explorer_3_methods);
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimplePackage2SimplePackage) o).getSource();
						edge_explorer_5 = new CachedEdgeExplorer(this, 0, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SimplePackage2SimplePackage) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimplePackage) o).getSimpleClasses();
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimplePackage) return edge_explorer_7_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleClass2SimpleClassRule__CO_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimplePackage2SimplePackage_object": 
				{
					...
					// SP2SP
					HMatch match_0 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CO_39_localSearch", 6);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_5_1_orchestration, match_0);
				}
				break;
			case "SimplePackage_object": 
				{
					
					// srcPackage
					HMatch match_1 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CO_39_localSearch", 6);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_5_2_orchestration, match_1);
					
					// trgPackage
					HMatch match_2 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CO_39_localSearch", 6);
			...
			case "SimpleClass2SimpleClass_object": 
				{
					...
					// SC2SC
					HMatch match_3 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CO_39_localSearch", 6);
			...
			case "SimpleClass_object": 
				{
					...
					// srcClass
					HMatch match_4 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CO_39_localSearch", 6);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_4_1_orchestration, match_4);
					
					// trgClass
					HMatch match_5 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CO_39_localSearch", 6);
		...
		case "SimpleClass2SimpleClass_target_SimpleClass": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleClass2SimpleClassRule__CO_39_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[3] = msg.source;
				objs[5] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.xtext.simplejava.simpleJava.SimpleClass srcClass = (org.xtext.simplejava.simpleJava.SimpleClass) match.getNodes()[4];
		org.xtext.simplejava.simpleJava.SimpleClass trgClass = (org.xtext.simplejava.simpleJava.SimpleClass) match.getNodes()[5];
