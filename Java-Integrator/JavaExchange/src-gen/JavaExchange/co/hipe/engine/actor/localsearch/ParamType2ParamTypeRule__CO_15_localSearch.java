...
public class ParamType2ParamTypeRule__CO_15_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleParam) o).getParamType();
						edge_explorer_4_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleParam) return o.equals(edge_explorer_4_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParam) o).getSource();
						edge_explorer_7 = new CachedEdgeExplorer(this, 0, 1, edge_explorer_7_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ParamType2ParamTypeRule__CO_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimpleParam2SimpleParam_object": 
				{
					...
					// SPa2SPa
					HMatch match_0 = new LocalSearchMatch("ParamType2ParamTypeRule__CO_15_localSearch", 6);
			...
			case "SimpleParam_object": 
				{
					...
					// srcParam
					HMatch match_1 = new LocalSearchMatch("ParamType2ParamTypeRule__CO_15_localSearch", 6);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_4_1_orchestration, match_1);
					
					// trgParam
					HMatch match_2 = new LocalSearchMatch("ParamType2ParamTypeRule__CO_15_localSearch", 6);
			...
			case "TypeRef2TypeRef_object_SP0": 
				{
					...
					// TR2TR
					HMatch match_3 = new LocalSearchMatch("ParamType2ParamTypeRule__CO_15_localSearch", 6);
			...
			case "JvmParameterizedTypeReference_object_SP0": 
				{
					...
					// srcRef
					HMatch match_4 = new LocalSearchMatch("ParamType2ParamTypeRule__CO_15_localSearch", 6);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_3_2_orchestration, match_4);
					
					// trgRef
					HMatch match_5 = new LocalSearchMatch("ParamType2ParamTypeRule__CO_15_localSearch", 6);
		...
		case "SimpleParam2SimpleParam_target_SimpleParam": 
			{
				...
				HMatch match = new LocalSearchMatch("ParamType2ParamTypeRule__CO_15_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
