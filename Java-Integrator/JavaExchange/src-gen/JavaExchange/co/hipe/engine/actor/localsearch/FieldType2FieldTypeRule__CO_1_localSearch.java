...
public class FieldType2FieldTypeRule__CO_1_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleField) o).getFieldType();
						edge_explorer_3_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleField) return o.equals(edge_explorer_3_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleField) o).getFieldType();
						edge_explorer_6_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleField) return o.equals(edge_explorer_6_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_6 = new EdgeExplorer(this, 2, 5, edge_explorer_6_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("FieldType2FieldTypeRule__CO_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimpleField2SimpleField_object": 
				{
					...
					// SF2SF
					HMatch match_0 = new LocalSearchMatch("FieldType2FieldTypeRule__CO_1_localSearch", 6);
			...
			case "SimpleField_object": 
				{
					...
					// srcField
					HMatch match_1 = new LocalSearchMatch("FieldType2FieldTypeRule__CO_1_localSearch", 6);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgField
					HMatch match_2 = new LocalSearchMatch("FieldType2FieldTypeRule__CO_1_localSearch", 6);
			...
			case "TypeRef2TypeRef_object_SP0": 
				{
					...
					// TR2TR
					HMatch match_3 = new LocalSearchMatch("FieldType2FieldTypeRule__CO_1_localSearch", 6);
			...
			case "JvmParameterizedTypeReference_object_SP0": 
				{
					...
					// srcRef
					HMatch match_4 = new LocalSearchMatch("FieldType2FieldTypeRule__CO_1_localSearch", 6);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_3_1_orchestration, match_4);
					
					// trgRef
					HMatch match_5 = new LocalSearchMatch("FieldType2FieldTypeRule__CO_1_localSearch", 6);
		...
		case "SimpleField2SimpleField_source_SimpleField": 
			{
				...
				HMatch match = new LocalSearchMatch("FieldType2FieldTypeRule__CO_1_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
