package JavaExchange.co.hipe.engine.actor.localsearch;
...
public class SimpleField2SimpleFieldRule__CO_46_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClass) o).getSource();
						edge_explorer = new CachedEdgeExplorer(this, 0, 1, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClass) o).getTarget();
						edge_explorer_3 = new CachedEdgeExplorer(this, 0, 2, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleField) o).getSource();
						edge_explorer_4 = new CachedEdgeExplorer(this, 3, 4, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleClass) o).getSimpleFields();
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleClass) return edge_explorer_5_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_5 = new EdgeExplorer(this, 2, 5, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleClass) o).getSimpleFields();
						edge_explorer_6_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleClass) return edge_explorer_6_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_6 = new EdgeExplorer(this, 1, 4, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleField) o).getTarget();
						edge_explorer_7 = new CachedEdgeExplorer(this, 3, 5, edge_explorer_7_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleField2SimpleFieldRule__CO_production"), this::returnTrue , 0  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "SimpleClass2SimpleClass_object": 
				{
					edge_explorer.registerSourceObject(objs[0]);
					edge_explorer_3.registerSourceObject(objs[0]);
					
					// SC2SC
					HMatch match_0 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CO_46_localSearch", 6);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_1_orchestration, match_0);
				}
				break;
			case "SimpleClass_object": 
				{
					
					// srcClass
					HMatch match_1 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CO_46_localSearch", 6);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CO_46_localSearch", 6);
			...
			case "SimpleField2SimpleField_object": 
				{
					...
					// SF2SF
					HMatch match_3 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CO_46_localSearch", 6);
			...
			case "SimpleField_object": 
				{
					...
					// srcField
					HMatch match_4 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CO_46_localSearch", 6);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_4_2_orchestration, match_4);
					
					// trgField
					HMatch match_5 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CO_46_localSearch", 6);
		...
		case "SimpleClass2SimpleClass_source_SimpleClass": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleField2SimpleFieldRule__CO_46_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.xtext.simplejava.simpleJava.SimpleField) {
			...
			if(formerMatches_4 != null) {
				...
				formerMatches_4 = formerMatches_4.stream().filter(m -> !constraint_checker.check(m) || !constraint_checker_0.check(m) || !constraint_checker_1.check(m) || !constraint_checker_2.check(m)).collect(Collectors.toList());
	...
	public boolean constraint_checker_method(HMatch match) {
		org.xtext.simplejava.simpleJava.SimpleField srcField = (org.xtext.simplejava.simpleJava.SimpleField) match.getNodes()[4];
		org.xtext.simplejava.simpleJava.SimpleField trgField = (org.xtext.simplejava.simpleJava.SimpleField) match.getNodes()[5];
