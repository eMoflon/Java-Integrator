...
public class SimpleMethod2SimpleMethodRule__CO_53_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleClass) o).getSimpleMethods();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethod) o).getSource();
						edge_explorer_5 = new CachedEdgeExplorer(this, 3, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethod) o).getTarget();
						edge_explorer_6 = new CachedEdgeExplorer(this, 3, 5, edge_explorer_6_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleMethod2SimpleMethodRule__CO_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimpleClass2SimpleClass_object": 
				{
					...
					// SC2SC
					HMatch match_0 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CO_53_localSearch", 6);
			...
			case "SimpleClass_object": 
				{
					...
					// srcClass
					HMatch match_1 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CO_53_localSearch", 6);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CO_53_localSearch", 6);
			...
			case "SimpleMethod2SimpleMethod_object": 
				{
					...
					// SM2SM
					HMatch match_3 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CO_53_localSearch", 6);
			...
			case "SimpleMethod_object": 
				{
					...
					// srcMethod
					HMatch match_4 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CO_53_localSearch", 6);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_3_2_orchestration, match_4);
					
					// trgMethod
					HMatch match_5 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CO_53_localSearch", 6);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "SimpleClass_simpleMethods_SimpleMethod": 
			{
				HMatch match = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CO_53_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[5] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.xtext.simplejava.simpleJava.SimpleMethod srcMethod = (org.xtext.simplejava.simpleJava.SimpleMethod) match.getNodes()[4];
		org.xtext.simplejava.simpleJava.SimpleMethod trgMethod = (org.xtext.simplejava.simpleJava.SimpleMethod) match.getNodes()[5];
