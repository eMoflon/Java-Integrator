...
public class SimpleParam2SimpleParamRule__CO_64_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethod) o).getSource();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new CachedEdgeExplorer(this, 3, 5, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParam) o).getSource();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleParam2SimpleParamRule__CO_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimpleMethod2SimpleMethod_object": 
				{
					...
					// SM2SM
					HMatch match_0 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CO_64_localSearch", 6);
			...
			case "SimpleMethod_object": 
				{
					...
					// srcMethod
					HMatch match_1 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CO_64_localSearch", 6);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_4_1_orchestration, match_1);
					
					// trgMethod
					HMatch match_2 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CO_64_localSearch", 6);
			...
			case "SimpleParam2SimpleParam_object": 
				{
					...
					// SPa2SPa
					HMatch match_3 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CO_64_localSearch", 6);
			...
			case "SimpleParam_object": 
				{
					...
					// srcParam
					HMatch match_4 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CO_64_localSearch", 6);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_6_1_orchestration, match_4);
					
					// trgParam
					HMatch match_5 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CO_64_localSearch", 6);
		...
		case "SimpleMethod2SimpleMethod_target_SimpleMethod": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleParam2SimpleParamRule__CO_64_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.xtext.simplejava.simpleJava.SimpleParam srcParam = (org.xtext.simplejava.simpleJava.SimpleParam) match.getNodes()[4];
		org.xtext.simplejava.simpleJava.SimpleParam trgParam = (org.xtext.simplejava.simpleJava.SimpleParam) match.getNodes()[5];
