...
public class SimplePackage2SimplePackageRule__CO_60_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SimplePackage2SimplePackage) o).getTarget();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimplePackage2SimplePackageRule__CO_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimplePackage2SimplePackage_object": 
				{
					...
					// SP2SP
					HMatch match_0 = new LocalSearchMatch("SimplePackage2SimplePackageRule__CO_60_localSearch", 3);
			...
			case "SimplePackage_object": 
				{
					...
					// srcPackage
					HMatch match_1 = new LocalSearchMatch("SimplePackage2SimplePackageRule__CO_60_localSearch", 3);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// trgPackage
					HMatch match_2 = new LocalSearchMatch("SimplePackage2SimplePackageRule__CO_60_localSearch", 3);
		...
		case "SimplePackage2SimplePackage_target_SimplePackage": 
			{
				...
				HMatch match = new LocalSearchMatch("SimplePackage2SimplePackageRule__CO_60_localSearch", 3);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		org.xtext.simplejava.simpleJava.SimplePackage trgPackage = (org.xtext.simplejava.simpleJava.SimplePackage) match.getNodes()[2];
