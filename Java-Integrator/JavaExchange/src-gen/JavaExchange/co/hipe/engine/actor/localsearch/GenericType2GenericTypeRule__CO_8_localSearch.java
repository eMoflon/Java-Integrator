...
public class GenericType2GenericTypeRule__CO_8_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType(); return (result instanceof org.eclipse.xtext.common.types.JvmGenericType ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 2, 5, edge_explorer_methods);
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getSource(); return (result instanceof org.eclipse.xtext.common.types.JvmGenericType ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 3, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType(); return (result instanceof org.eclipse.xtext.common.types.JvmGenericType ? result : null);};
						edge_explorer_6 = new CachedEdgeExplorer(this, 1, 4, edge_explorer_6_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("GenericType2GenericTypeRule__CO_production"), this::returnTrue , 0  , false ));
	}
			...
			case "TypeRef2TypeRef_object_SP1": 
				{
					...
					// a2a
					HMatch match_0 = new LocalSearchMatch("GenericType2GenericTypeRule__CO_8_localSearch", 6);
			...
			case "JvmParameterizedTypeReference_object_SP1": 
				{
					...
					// srcRef
					HMatch match_1 = new LocalSearchMatch("GenericType2GenericTypeRule__CO_8_localSearch", 6);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_4_2_orchestration, match_1);
					edge_explorer.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("GenericType2GenericTypeRule__CO_8_localSearch", 6);
			...
			case "Type2Type_object": 
				{
					...
					// b2b
					HMatch match_3 = new LocalSearchMatch("GenericType2GenericTypeRule__CO_8_localSearch", 6);
			...
			case "JvmGenericType_object": 
				{
					...
					// srcType
					HMatch match_4 = new LocalSearchMatch("GenericType2GenericTypeRule__CO_8_localSearch", 6);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_5_1_orchestration, match_4);
					
					// trgType
					HMatch match_5 = new LocalSearchMatch("GenericType2GenericTypeRule__CO_8_localSearch", 6);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "JvmParameterizedTypeReference_type_JvmType": 
			if(msg.target instanceof org.eclipse.xtext.common.types.JvmGenericType) {
			{
				...
				HMatch match = new LocalSearchMatch("GenericType2GenericTypeRule__CO_8_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[5] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.eclipse.xtext.common.types.JvmGenericType srcType = (org.eclipse.xtext.common.types.JvmGenericType) match.getNodes()[4];
		org.eclipse.xtext.common.types.JvmGenericType trgType = (org.eclipse.xtext.common.types.JvmGenericType) match.getNodes()[5];
