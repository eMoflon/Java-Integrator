...
public class PrimitiveType2PrimitiveTypeRule__CO_22_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new CachedEdgeExplorer(this, 2, 5, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getTarget(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 3, 5, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 1, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getSource(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("PrimitiveType2PrimitiveTypeRule__CO_production"), this::returnTrue , 0  , false ));
	}
			...
			case "TypeRef2TypeRef_object_SP1": 
				{
					...
					// TR2TR
					HMatch match_0 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CO_22_localSearch", 6);
			...
			case "JvmParameterizedTypeReference_object_SP1": 
				{
					...
					// srcRef
					HMatch match_1 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CO_22_localSearch", 6);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					edge_explorer_3.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CO_22_localSearch", 6);
			...
			case "Type2Type_object": 
				{
					...
					// T2T
					HMatch match_3 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CO_22_localSearch", 6);
			...
			case "JvmPrimitiveType_object": 
				{
					...
					// srcType
					HMatch match_4 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CO_22_localSearch", 6);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_5_1_orchestration, match_4);
					
					// trgType
					HMatch match_5 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CO_22_localSearch", 6);
		...
		case "TypeRef2TypeRef_source_JvmParameterizedTypeReference": 
			{
				...
				HMatch match = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CO_22_localSearch", 6);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.eclipse.xtext.common.types.JvmPrimitiveType srcType = (org.eclipse.xtext.common.types.JvmPrimitiveType) match.getNodes()[4];
		org.eclipse.xtext.common.types.JvmPrimitiveType trgType = (org.eclipse.xtext.common.types.JvmPrimitiveType) match.getNodes()[5];
