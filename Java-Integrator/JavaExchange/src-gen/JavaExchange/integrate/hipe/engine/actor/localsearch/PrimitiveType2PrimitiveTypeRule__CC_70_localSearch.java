...
public class PrimitiveType2PrimitiveTypeRule__CC_70_localSearch extends GenericLocalSearchActor{
			...
			case "TypeRef2TypeRef_object_SP0": 
				{
					...
					// TR2TR
					HMatch match_0 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CC_70_localSearch", 5);
			...
			case "JvmParameterizedTypeReference_object_SP1": 
				{
					...
					// srcRef
					HMatch match_1 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CC_70_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_2_orchestration, match_1);
					edge_explorer.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CC_70_localSearch", 5);
			...
			case "JvmPrimitiveType_object": 
				{
					...
					// srcType
					HMatch match_3 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CC_70_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_5_1_orchestration, match_3);
					
					// trgType
					HMatch match_4 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CC_70_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "JvmParameterizedTypeReference_type_JvmType": 
			if(msg.target instanceof org.eclipse.xtext.common.types.JvmPrimitiveType) {
			{
				...
				HMatch match = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CC_70_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
