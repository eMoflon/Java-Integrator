...
public class SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						...
						edge_explorer_3 = new CachedEdgeExplorer(this, 1, 6, edge_explorer_3_methods);
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						...
						edge_explorer_6 = new CachedEdgeExplorer(this, 6, 8, edge_explorer_6_methods);
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						...
						edge_explorer_8 = new CachedEdgeExplorer(this, 2, 4, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		pac_explorer = new PACExplorer(this, Arrays.asList(new Integer[] {3,4,5}), node.getAllOverlaps().get(0));
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_117_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("SecondTypeRef2SecondTypeRefRule__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "Type2Type_object_SP0": 
				{
					...
					// T2T
					HMatch match_0 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch", 9);
			...
			case "TypeRef2TypeRef_object_SP1": 
				{
					...
					// TR2TR
					HMatch match_1 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch", 9);
					...
					// TR2TR2
					HMatch match_2 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch", 9);
			...
			case "JvmParameterizedTypeReference_object_SP1": 
				{
					...
					// srcRef
					HMatch match_3 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch", 9);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_2_orchestration, match_3);
					
					// srcRef2
					HMatch match_4 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch", 9);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_8_1_orchestration, match_4);
					edge_explorer_6.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_6 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch", 9);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
					
					// trgRef2
					HMatch match_7 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch", 9);
					match_7.getNodes()[7] = objs[0];
					start(edge_explorer_5_2_orchestration, match_7);
				}
				break;
			case "JvmType_object_SP1": 
				{
					
					// srcType
					HMatch match_5 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch", 9);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_4_2_orchestration, match_5);
					
					// trgType
					HMatch match_8 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch", 9);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_6_1_orchestration, match_8);
				}
				break;
			case "SecondTypeRef2SecondTypeRefRule__SRC_106_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch", 9);
		...
		case "TypeRef2TypeRef_source_JvmParameterizedTypeReference": 
			{
				...
				HMatch match = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register SecondTypeRef2SecondTypeRefRule__SRC
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister SecondTypeRef2SecondTypeRefRule__SRC
		OverlapMatch oMatch_0 = new OverlapMatch(3);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[3];
		oMatch_Nodes_0[1] = objs[4];
