...
public class SimpleField2SimpleFieldRule__CC_146_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						...
						edge_explorer_5 = new CachedEdgeExplorer(this, 0, 2, edge_explorer_5_methods);
			...
			case "SimpleClass2SimpleClass_object_SP0": 
				{
					...
					// SC2SC
					HMatch match_0 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CC_146_localSearch", 5);
			...
			case "SimpleClass_object_SP1": 
				{
					...
					// srcClass
					HMatch match_1 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CC_146_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CC_146_localSearch", 5);
			...
			case "SimpleField_object_SP0": 
				{
					...
					// srcField
					HMatch match_3 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CC_146_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_3_1_orchestration, match_3);
					
					// trgField
					HMatch match_4 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CC_146_localSearch", 5);
		...
		case "SimpleClass2SimpleClass_source_SimpleClass": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleField2SimpleFieldRule__CC_146_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
