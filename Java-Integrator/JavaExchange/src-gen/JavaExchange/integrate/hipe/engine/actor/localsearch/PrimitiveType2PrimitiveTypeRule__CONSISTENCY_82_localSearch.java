...
public class PrimitiveType2PrimitiveTypeRule__CONSISTENCY_82_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getTarget(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 4, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCONTEXT__SRC__srcRef();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCREATE__SRC__srcType();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCREATE__TRG__trgType();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCONTEXT__CORR__TR2TR();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getSource(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
		...
		pac_explorer_0 = new PACExplorer(this, Arrays.asList(new Integer[] {0,2,3,5}), node.getAllOverlaps().get(1));
			...
			case "Type2Type_object_SP1": 
				{
					...
					// T2T
					HMatch match_4 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_82_localSearch", 7);
			...
			case "PrimitiveType2PrimitiveTypeRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_82_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "PrimitiveType2PrimitiveTypeRule__FWD_79_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_82_localSearch", 7);
				...
				break;
			case "PrimitiveType2PrimitiveTypeRule__BWD_67_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_82_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Type2Type_target_JvmType": 
			if(msg.target instanceof org.eclipse.xtext.common.types.JvmPrimitiveType) {
			{
				...
				HMatch match = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_82_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[4] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register PrimitiveType2PrimitiveTypeRule__FWD
		...
		// register PrimitiveType2PrimitiveTypeRule__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister PrimitiveType2PrimitiveTypeRule__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister PrimitiveType2PrimitiveTypeRule__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.eclipse.xtext.common.types.JvmPrimitiveType) {
			HMatch match_1 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_82_localSearch", 7);
			...
			HMatch match_3 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_82_localSearch", 7);
