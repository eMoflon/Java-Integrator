...
public class SimpleField2SimpleFieldRule__CONSISTENCY_158_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleField) o).getSource();
						edge_explorer = new CachedEdgeExplorer(this, 5, 1, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCREATE__CORR__SF2SF();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 5, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleField) o).getTarget();
						edge_explorer_4 = new CachedEdgeExplorer(this, 5, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCREATE__SRC__srcField();
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCONTEXT__SRC__srcClass();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCONTEXT__TRG__trgClass();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCREATE__TRG__trgField();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCONTEXT__CORR__SC2SC();
			...
			case "SimpleField2SimpleField_object": 
				{
					...
					// SF2SF
					HMatch match_5 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_158_localSearch", 7);
			...
			case "SimpleField2SimpleFieldRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_158_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "SimpleField2SimpleFieldRule__FWD_155_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_158_localSearch", 7);
				...
				break;
			case "SimpleField2SimpleFieldRule__BWD_143_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_158_localSearch", 7);
						acMatch_1.getNodes()[0] = objs[1];
						acMatch_1.getNodes()[2] = objs[2];
						acMatch_1.getNodes()[3] = objs[3];
						acMatch_1.getNodes()[4] = objs[0];
		...
		case "SimpleField2SimpleField_source_SimpleField": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_158_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register SimpleField2SimpleFieldRule__FWD
		...
		// register SimpleField2SimpleFieldRule__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister SimpleField2SimpleFieldRule__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister SimpleField2SimpleFieldRule__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.xtext.simplejava.simpleJava.SimpleField) {
			HMatch match_1 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_158_localSearch", 7);
			...
			HMatch match_3 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_158_localSearch", 7);
