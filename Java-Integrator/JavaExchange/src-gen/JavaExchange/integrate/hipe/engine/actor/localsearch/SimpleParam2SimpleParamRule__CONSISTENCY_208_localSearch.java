...
public class SimpleParam2SimpleParamRule__CONSISTENCY_208_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParamRule__Marker) o).getCONTEXT__SRC__srcMethod();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParamRule__Marker) o).getCREATE__TRG__trgParam();
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParamRule__Marker) o).getCONTEXT__TRG__trgMethod();
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParamRule__Marker) o).getCREATE__SRC__srcParam();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParam) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParamRule__Marker) o).getCONTEXT__CORR__SM2SM();
			...
			case "SimpleParam2SimpleParam_object": 
				{
					...
					// SPa2SPa
					HMatch match_5 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_208_localSearch", 7);
			...
			case "SimpleParam2SimpleParamRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_208_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "SimpleParam2SimpleParamRule__FWD_205_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_208_localSearch", 7);
				...
				break;
			case "SimpleParam2SimpleParamRule__BWD_193_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_208_localSearch", 7);
		...
		case "SimpleParam2SimpleParamRule__Marker_CREATE__CORR__SPa2SPa_SimpleParam2SimpleParam": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_208_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[6] = msg.source;
				objs[5] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register SimpleParam2SimpleParamRule__FWD
		...
		// register SimpleParam2SimpleParamRule__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister SimpleParam2SimpleParamRule__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister SimpleParam2SimpleParamRule__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.xtext.simplejava.simpleJava.SimpleParam) {
			HMatch match_1 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_208_localSearch", 7);
			...
			HMatch match_3 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_208_localSearch", 7);
