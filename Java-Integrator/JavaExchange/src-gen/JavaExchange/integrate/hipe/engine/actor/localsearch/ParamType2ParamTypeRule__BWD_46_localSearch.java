...
public class ParamType2ParamTypeRule__BWD_46_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("ParamType2ParamTypeRule__CONSISTENCY_61_localSearch"), this::returnTrue  , false ));
	}
			...
			case "SimpleParam2SimpleParam_object": 
				{
					...
					// SPa2SPa
					HMatch match_0 = new LocalSearchMatch("ParamType2ParamTypeRule__BWD_46_localSearch", 4);
			...
			case "SimpleParam_object_SP0": 
				{
					...
					// srcParam
					HMatch match_1 = new LocalSearchMatch("ParamType2ParamTypeRule__BWD_46_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// trgParam
					HMatch match_2 = new LocalSearchMatch("ParamType2ParamTypeRule__BWD_46_localSearch", 4);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_2_orchestration, match_2);
				}
				break;
			case "ParamType2ParamTypeRule__TRG_43_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ParamType2ParamTypeRule__BWD_46_localSearch", 4);
		...
		case "SimpleParam2SimpleParam_target_SimpleParam": 
			{
				...
				HMatch match = new LocalSearchMatch("ParamType2ParamTypeRule__BWD_46_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ParamType2ParamTypeRule__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ParamType2ParamTypeRule__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[2];
		oMatch_Nodes_0[1] = objs[3];
