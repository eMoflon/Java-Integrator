...
public class SimpleClass2SimpleClassRule__CC_125_localSearch extends GenericLocalSearchActor{
			...
			case "SimplePackage2SimplePackage_object": 
				{
					...
					// SP2SP
					HMatch match_0 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CC_125_localSearch", 5);
			...
			case "SimplePackage_object_SP2": 
				{
					...
					// srcPackage
					HMatch match_1 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CC_125_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgPackage
					HMatch match_2 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CC_125_localSearch", 5);
			...
			case "SimpleClass_object_SP1": 
				{
					...
					// srcClass
					HMatch match_3 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CC_125_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_5_1_orchestration, match_3);
					
					// trgClass
					HMatch match_4 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CC_125_localSearch", 5);
		...
		case "SimplePackage2SimplePackage_source_SimplePackage": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleClass2SimpleClassRule__CC_125_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
