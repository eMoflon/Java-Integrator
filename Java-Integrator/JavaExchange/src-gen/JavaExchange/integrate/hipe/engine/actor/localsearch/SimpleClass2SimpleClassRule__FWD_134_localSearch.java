...
public class SimpleClass2SimpleClassRule__FWD_134_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleClass2SimpleClassRule__CONSISTENCY_137_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("SimpleClass2SimpleClassRule__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimplePackage2SimplePackage_object": 
				{
					...
					// SP2SP
					HMatch match_0 = new LocalSearchMatch("SimpleClass2SimpleClassRule__FWD_134_localSearch", 4);
			...
			case "SimplePackage_object_SP0": 
				{
					...
					// srcPackage
					HMatch match_1 = new LocalSearchMatch("SimpleClass2SimpleClassRule__FWD_134_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgPackage
					HMatch match_2 = new LocalSearchMatch("SimpleClass2SimpleClassRule__FWD_134_localSearch", 4);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_3_1_orchestration, match_2);
				}
				break;
			case "SimpleClass2SimpleClassRule__SRC_131_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("SimpleClass2SimpleClassRule__FWD_134_localSearch", 4);
		...
		case "SimplePackage2SimplePackage_source_SimplePackage": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleClass2SimpleClassRule__FWD_134_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register SimpleClass2SimpleClassRule__SRC
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister SimpleClass2SimpleClassRule__SRC
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[1];
		oMatch_Nodes_0[1] = objs[3];
