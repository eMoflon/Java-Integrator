...
public class SimpleMethod2SimpleMethodRule__CONSISTENCY_179_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCREATE__CORR__SM2SM();
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCREATE__TRG__trgMethod();
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCONTEXT__CORR__SC2SC();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCREATE__SRC__srcMethod();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCONTEXT__SRC__srcClass();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethod) o).getTarget();
			...
			case "SimpleMethod2SimpleMethod_object": 
				{
					...
					// SM2SM
					HMatch match_5 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_179_localSearch", 7);
			...
			case "SimpleMethod2SimpleMethodRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_179_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "SimpleMethod2SimpleMethodRule__FWD_176_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_179_localSearch", 7);
				...
				break;
			case "SimpleMethod2SimpleMethodRule__BWD_164_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_179_localSearch", 7);
		...
		case "SimpleMethod2SimpleMethodRule__Marker_CREATE__CORR__SM2SM_SimpleMethod2SimpleMethod": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_179_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[6] = msg.source;
				objs[5] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register SimpleMethod2SimpleMethodRule__FWD
		...
		// register SimpleMethod2SimpleMethodRule__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister SimpleMethod2SimpleMethodRule__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister SimpleMethod2SimpleMethodRule__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.xtext.simplejava.simpleJava.SimpleMethod) {
			HMatch match_1 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_179_localSearch", 7);
			...
			HMatch match_3 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_179_localSearch", 7);
