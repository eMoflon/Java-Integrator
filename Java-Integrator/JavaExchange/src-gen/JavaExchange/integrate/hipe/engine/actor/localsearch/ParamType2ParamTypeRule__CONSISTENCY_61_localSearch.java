...
public class ParamType2ParamTypeRule__CONSISTENCY_61_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCONTEXT__SRC__srcParam();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCREATE__TRG__trgRef();
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCREATE__SRC__srcRef();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCONTEXT__TRG__trgParam();
			...
			case "TypeRef2TypeRef_object_SP1": 
				{
					...
					// TR2TR
					HMatch match_5 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_61_localSearch", 7);
			...
			case "ParamType2ParamTypeRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_61_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_3_1_orchestration, match_6);
				}
				break;
			case "ParamType2ParamTypeRule__FWD_58_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_61_localSearch", 7);
				...
				break;
			case "ParamType2ParamTypeRule__BWD_46_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_61_localSearch", 7);
		...
		case "TypeRef2TypeRef_target_JvmParameterizedTypeReference": 
			{
				...
				HMatch match = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_61_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register ParamType2ParamTypeRule__FWD
		...
		// register ParamType2ParamTypeRule__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister ParamType2ParamTypeRule__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister ParamType2ParamTypeRule__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[2];
