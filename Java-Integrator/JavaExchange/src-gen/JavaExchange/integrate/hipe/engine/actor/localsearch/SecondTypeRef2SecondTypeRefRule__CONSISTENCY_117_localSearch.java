...
public class SecondTypeRef2SecondTypeRefRule__CONSISTENCY_117_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__SRC__srcRef2();
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__TRG__trgType();
						edge_explorer_4 = new CachedEdgeExplorer(this, 9, 5, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__SRC__srcRef();
						edge_explorer_5 = new CachedEdgeExplorer(this, 9, 0, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__TRG__trgRef2();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__CORR__TR2TR2();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__TRG__trgRef();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__SRC__srcType();
			...
			case "SecondTypeRef2SecondTypeRefRule__Marker_object": 
				{
					...
					HMatch match_9 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_117_localSearch", 10);
					match_9.getNodes()[9] = objs[0];
					start(edge_explorer_1_orchestration, match_9);
				}
				break;
			case "SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_117_localSearch", 10);
						acMatch_0.getNodes()[0] = objs[3];
						acMatch_0.getNodes()[1] = objs[4];
						acMatch_0.getNodes()[2] = objs[5];
						acMatch_0.getNodes()[3] = objs[6];
						acMatch_0.getNodes()[4] = objs[7];
						acMatch_0.getNodes()[5] = objs[8];
				...
				break;
			case "SecondTypeRef2SecondTypeRefRule__BWD_89_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_117_localSearch", 10);
						acMatch_1.getNodes()[0] = objs[3];
						acMatch_1.getNodes()[1] = objs[4];
						acMatch_1.getNodes()[2] = objs[5];
						acMatch_1.getNodes()[3] = objs[6];
						acMatch_1.getNodes()[4] = objs[7];
						acMatch_1.getNodes()[5] = objs[8];
						acMatch_1.getNodes()[6] = objs[0];
		...
		switch(match.creator) {
			...
			case "SecondTypeRef2SecondTypeRefRule__FWD_110_localSearch": 
				if(pac_explorer.deregister(match)) {
					...
					acMatch_0.getNodes()[4] = match.getNodes()[7];
					acMatch_0.getNodes()[5] = match.getNodes()[8];
			...
			case "SecondTypeRef2SecondTypeRefRule__BWD_89_localSearch": 
				if(pac_explorer_0.deregister(match)) {
					...
					acMatch_1.getNodes()[2] = match.getNodes()[5];
					...
					acMatch_1.getNodes()[8] = match.getNodes()[2];
		...
		case "SecondTypeRef2SecondTypeRefRule__Marker_CONTEXT__SRC__srcRef2_JvmParameterizedTypeReference": 
			{
				...
				HMatch match = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_117_localSearch", 10);
				Object[] objs = match.getNodes();
				objs[9] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register SecondTypeRef2SecondTypeRefRule__FWD
		...
		// register SecondTypeRef2SecondTypeRefRule__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister SecondTypeRef2SecondTypeRefRule__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(9);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister SecondTypeRef2SecondTypeRefRule__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(9);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[1];
