...
public class SimpleMethod2SimpleMethodRule__CC_167_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClass) o).getTarget();
			...
			case "SimpleClass2SimpleClass_object_SP1": 
				{
					...
					// SC2SC
					HMatch match_0 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CC_167_localSearch", 5);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_1_orchestration, match_0);
				}
				break;
			case "SimpleClass_object_SP2": 
				{
					
					// srcClass
					HMatch match_1 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CC_167_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CC_167_localSearch", 5);
			...
			case "SimpleMethod_object_SP1": 
				{
					...
					// srcMethod
					HMatch match_3 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CC_167_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_5_1_orchestration, match_3);
					
					// trgMethod
					HMatch match_4 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CC_167_localSearch", 5);
		...
		case "SimpleClass2SimpleClass_source_SimpleClass": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CC_167_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
