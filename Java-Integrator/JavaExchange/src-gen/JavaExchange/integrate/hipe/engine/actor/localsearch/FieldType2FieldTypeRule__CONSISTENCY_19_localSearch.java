...
public class FieldType2FieldTypeRule__CONSISTENCY_19_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCREATE__SRC__srcRef();
						edge_explorer = new CachedEdgeExplorer(this, 6, 1, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCREATE__TRG__trgRef();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.TypeRef2TypeRef) o).getTarget();
						edge_explorer_5 = new CachedEdgeExplorer(this, 5, 3, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCONTEXT__CORR__SF2SF();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCONTEXT__TRG__trgField();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCONTEXT__SRC__srcField();
			...
			case "TypeRef2TypeRef_object_SP0": 
				{
					...
					// TR2TR
					HMatch match_5 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_19_localSearch", 7);
			...
			case "FieldType2FieldTypeRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_19_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "FieldType2FieldTypeRule__FWD_16_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_19_localSearch", 7);
				...
				break;
			case "FieldType2FieldTypeRule__BWD_4_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_19_localSearch", 7);
		...
		case "FieldType2FieldTypeRule__Marker_CREATE__SRC__srcRef_JvmParameterizedTypeReference": 
			{
				...
				HMatch match = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_19_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[6] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register FieldType2FieldTypeRule__FWD
		...
		// register FieldType2FieldTypeRule__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister FieldType2FieldTypeRule__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister FieldType2FieldTypeRule__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[2];
