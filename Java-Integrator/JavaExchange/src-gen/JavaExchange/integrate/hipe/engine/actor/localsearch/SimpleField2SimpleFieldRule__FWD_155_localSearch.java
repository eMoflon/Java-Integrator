...
public class SimpleField2SimpleFieldRule__FWD_155_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleField2SimpleFieldRule__CONSISTENCY_158_localSearch"), this::returnTrue  , false ));
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("SimpleField2SimpleFieldRule__FWD_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimpleClass2SimpleClass_object_SP1": 
				{
					...
					// SC2SC
					HMatch match_0 = new LocalSearchMatch("SimpleField2SimpleFieldRule__FWD_155_localSearch", 4);
			...
			case "SimpleClass_object_SP2": 
				{
					...
					// srcClass
					HMatch match_1 = new LocalSearchMatch("SimpleField2SimpleFieldRule__FWD_155_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleField2SimpleFieldRule__FWD_155_localSearch", 4);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_2_orchestration, match_2);
				}
				break;
			case "SimpleField2SimpleFieldRule__SRC_152_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("SimpleField2SimpleFieldRule__FWD_155_localSearch", 4);
		...
		case "SimpleClass2SimpleClass_target_SimpleClass": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleField2SimpleFieldRule__FWD_155_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register SimpleField2SimpleFieldRule__SRC
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister SimpleField2SimpleFieldRule__SRC
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[1];
		oMatch_Nodes_0[1] = objs[3];
