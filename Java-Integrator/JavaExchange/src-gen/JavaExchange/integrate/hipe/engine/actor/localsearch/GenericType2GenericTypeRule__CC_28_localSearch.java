...
public class GenericType2GenericTypeRule__CC_28_localSearch extends GenericLocalSearchActor{
			...
			case "TypeRef2TypeRef_object_SP2": 
				{
					...
					// a2a
					HMatch match_0 = new LocalSearchMatch("GenericType2GenericTypeRule__CC_28_localSearch", 5);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_3_1_orchestration, match_0);
				}
				break;
			case "JvmParameterizedTypeReference_object_SP5": 
				{
					edge_explorer_4.registerSourceObject(objs[0]);
					
					// srcRef
					HMatch match_1 = new LocalSearchMatch("GenericType2GenericTypeRule__CC_28_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_4_1_orchestration, match_1);
					edge_explorer.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("GenericType2GenericTypeRule__CC_28_localSearch", 5);
			...
			case "JvmGenericType_object": 
				{
					...
					// srcType
					HMatch match_3 = new LocalSearchMatch("GenericType2GenericTypeRule__CC_28_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_4_2_orchestration, match_3);
					
					// trgType
					HMatch match_4 = new LocalSearchMatch("GenericType2GenericTypeRule__CC_28_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "JvmParameterizedTypeReference_type_JvmType": 
			if(msg.target instanceof org.eclipse.xtext.common.types.JvmGenericType) {
			{
				...
				HMatch match = new LocalSearchMatch("GenericType2GenericTypeRule__CC_28_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
