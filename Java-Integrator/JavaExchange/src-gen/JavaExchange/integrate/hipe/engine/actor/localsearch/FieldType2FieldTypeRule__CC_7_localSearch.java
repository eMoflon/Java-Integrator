...
public class FieldType2FieldTypeRule__CC_7_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("FieldType2FieldTypeRule__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimpleField2SimpleField_object": 
				{
					...
					// SF2SF
					HMatch match_0 = new LocalSearchMatch("FieldType2FieldTypeRule__CC_7_localSearch", 5);
			...
			case "SimpleField_object_SP0": 
				{
					...
					// srcField
					HMatch match_1 = new LocalSearchMatch("FieldType2FieldTypeRule__CC_7_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// trgField
					HMatch match_2 = new LocalSearchMatch("FieldType2FieldTypeRule__CC_7_localSearch", 5);
			...
			case "JvmParameterizedTypeReference_object_SP1": 
				{
					...
					// srcRef
					HMatch match_3 = new LocalSearchMatch("FieldType2FieldTypeRule__CC_7_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_3_2_orchestration, match_3);
					
					// trgRef
					HMatch match_4 = new LocalSearchMatch("FieldType2FieldTypeRule__CC_7_localSearch", 5);
		...
		case "SimpleField2SimpleField_target_SimpleField": 
			{
				...
				HMatch match = new LocalSearchMatch("FieldType2FieldTypeRule__CC_7_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
