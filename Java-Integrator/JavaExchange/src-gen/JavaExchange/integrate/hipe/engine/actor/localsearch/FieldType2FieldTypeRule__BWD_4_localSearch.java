...
public class FieldType2FieldTypeRule__BWD_4_localSearch extends GenericLocalSearchActor{
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(1), getSelf(), name2actor.get("FieldType2FieldTypeRule__CONSISTENCY_19_localSearch"), this::returnTrue  , false ));
	}
			...
			case "SimpleField2SimpleField_object": 
				{
					...
					// SF2SF
					HMatch match_0 = new LocalSearchMatch("FieldType2FieldTypeRule__BWD_4_localSearch", 4);
			...
			case "SimpleField_object_SP0": 
				{
					...
					// srcField
					HMatch match_1 = new LocalSearchMatch("FieldType2FieldTypeRule__BWD_4_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgField
					HMatch match_2 = new LocalSearchMatch("FieldType2FieldTypeRule__BWD_4_localSearch", 4);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_3_1_orchestration, match_2);
				}
				break;
			case "FieldType2FieldTypeRule__TRG_1_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("FieldType2FieldTypeRule__BWD_4_localSearch", 4);
		...
		case "SimpleField2SimpleField_source_SimpleField": 
			{
				...
				HMatch match = new LocalSearchMatch("FieldType2FieldTypeRule__BWD_4_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register FieldType2FieldTypeRule__TRG
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister FieldType2FieldTypeRule__TRG
		OverlapMatch oMatch_0 = new OverlapMatch(2);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[2];
		oMatch_Nodes_0[1] = objs[3];
