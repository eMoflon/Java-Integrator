...
public class GenericType2GenericTypeRule__CONSISTENCY_40_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCREATE__CORR__b2b();
						edge_explorer = new CachedEdgeExplorer(this, 6, 5, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCREATE__TRG__trgType();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCONTEXT__CORR__a2a();
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCONTEXT__TRG__trgRef();
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getSource(); return (result instanceof org.eclipse.xtext.common.types.JvmGenericType ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCONTEXT__SRC__srcRef();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCREATE__SRC__srcType();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getTarget(); return (result instanceof org.eclipse.xtext.common.types.JvmGenericType ? result : null);};
			...
			case "Type2Type_object_SP0": 
				{
					...
					// b2b
					HMatch match_5 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_40_localSearch", 7);
			...
			case "GenericType2GenericTypeRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_40_localSearch", 7);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_1_orchestration, match_6);
				}
				break;
			case "GenericType2GenericTypeRule__FWD_37_localSearch": 
				{
					if(pac_explorer.register(match)) {
						HMatch acMatch_0 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_40_localSearch", 7);
				...
				break;
			case "GenericType2GenericTypeRule__BWD_25_localSearch": 
				{
					if(pac_explorer_0.register(match)) {
						HMatch acMatch_1 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_40_localSearch", 7);
		...
		case "GenericType2GenericTypeRule__Marker_CREATE__CORR__b2b_Type2Type": 
			{
				...
				HMatch match = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_40_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[6] = msg.source;
				objs[5] = msg.target;
				currentDepth++;
	...
	protected void registerMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// register GenericType2GenericTypeRule__FWD
		...
		// register GenericType2GenericTypeRule__BWD
	...
	protected void deregisterMatch(HMatch match) {
		...
		Object[] objs = match.getNodes();
		// deregister GenericType2GenericTypeRule__FWD
		OverlapMatch oMatch_0 = new OverlapMatch(4);
		Object[] oMatch_Nodes_0 = oMatch_0.getNodes();
		oMatch_Nodes_0[0] = objs[0];
		oMatch_Nodes_0[1] = objs[1];
		...
		// deregister GenericType2GenericTypeRule__BWD
		OverlapMatch oMatch_1 = new OverlapMatch(4);
		Object[] oMatch_Nodes_1 = oMatch_1.getNodes();
		oMatch_Nodes_1[0] = objs[0];
		oMatch_Nodes_1[1] = objs[2];
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.eclipse.xtext.common.types.JvmGenericType) {
			HMatch match_1 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_40_localSearch", 7);
			...
			HMatch match_3 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_40_localSearch", 7);
