...
public class PrimitiveType2PrimitiveTypeRule__CC_43_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("PrimitiveType2PrimitiveTypeRule__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "TypeRef2TypeRef_object_SP0": 
				{
					...
					// TR2TR
					HMatch match_0 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CC_43_localSearch", 5);
			...
			case "JvmParameterizedTypeReference_object_SP0": 
				{
					...
					// srcRef
					HMatch match_1 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CC_43_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_1_orchestration, match_1);
					edge_explorer_5.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CC_43_localSearch", 5);
			...
			case "JvmPrimitiveType_object": 
				{
					...
					// srcType
					HMatch match_3 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CC_43_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_2_orchestration, match_3);
					
					// trgType
					HMatch match_4 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CC_43_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "JvmParameterizedTypeReference_type_JvmType": 
			if(msg.target instanceof org.eclipse.xtext.common.types.JvmPrimitiveType) {
			{
				...
				HMatch match = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CC_43_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.eclipse.xtext.common.types.JvmPrimitiveType srcType = (org.eclipse.xtext.common.types.JvmPrimitiveType) match.getNodes()[3];
		org.eclipse.xtext.common.types.JvmPrimitiveType trgType = (org.eclipse.xtext.common.types.JvmPrimitiveType) match.getNodes()[4];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_4 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_4.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcType.getSimpleName(), "java.lang.String"));
		csp_4.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgType.getSimpleName(), "java.lang.String"));
		csp_4.solve();
