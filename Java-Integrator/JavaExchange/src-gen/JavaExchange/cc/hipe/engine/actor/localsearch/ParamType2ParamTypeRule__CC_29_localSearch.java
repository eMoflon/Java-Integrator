...
public class ParamType2ParamTypeRule__CC_29_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParam) o).getTarget();
			...
			case "SimpleParam2SimpleParam_object": 
				{
					...
					// SPa2SPa
					HMatch match_0 = new LocalSearchMatch("ParamType2ParamTypeRule__CC_29_localSearch", 5);
			...
			case "SimpleParam_object": 
				{
					...
					// srcParam
					HMatch match_1 = new LocalSearchMatch("ParamType2ParamTypeRule__CC_29_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// trgParam
					HMatch match_2 = new LocalSearchMatch("ParamType2ParamTypeRule__CC_29_localSearch", 5);
			...
			case "JvmParameterizedTypeReference_object_SP1": 
				{
					...
					// srcRef
					HMatch match_3 = new LocalSearchMatch("ParamType2ParamTypeRule__CC_29_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_3_2_orchestration, match_3);
					
					// trgRef
					HMatch match_4 = new LocalSearchMatch("ParamType2ParamTypeRule__CC_29_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "SimpleParam_paramType_JvmParameterizedTypeReference": 
			{
				HMatch match = new LocalSearchMatch("ParamType2ParamTypeRule__CC_29_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
