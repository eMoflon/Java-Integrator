...
public class SimpleMethod2SimpleMethodRule__CONSISTENCY_112_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethod) o).getTarget();
						edge_explorer = new CachedEdgeExplorer(this, 5, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleClass) o).getSimpleMethods();
						edge_explorer_3_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleClass) return edge_explorer_3_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_3 = new EdgeExplorer(this, 2, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCONTEXT__SRC__srcClass();
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCONTEXT__TRG__trgClass();
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCREATE__CORR__SM2SM();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCREATE__TRG__trgMethod();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCONTEXT__CORR__SC2SC();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClass) o).getSource();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClass) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCREATE__SRC__srcMethod();
			...
			case "SimpleClass_object_SP1": 
				{
					...
					// srcClass
					HMatch match_0 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_112_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_4_2_orchestration, match_0);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_112_localSearch", 7);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_3_1_orchestration, match_2);
				}
				break;
			case "SimpleMethod_object": 
				{
					
					// srcMethod
					HMatch match_1 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_112_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_7_1_orchestration, match_1);
					
					// trgMethod
					HMatch match_3 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_112_localSearch", 7);
			...
			case "SimpleClass2SimpleClass_object_SP0": 
				{
					...
					// SC2SC
					HMatch match_4 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_112_localSearch", 7);
			...
			case "SimpleMethod2SimpleMethod_object": 
				{
					...
					// SM2SM
					HMatch match_5 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_112_localSearch", 7);
			...
			case "SimpleMethod2SimpleMethodRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_112_localSearch", 7);
		...
		case "SimpleMethod2SimpleMethod_target_SimpleMethod": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_112_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_18.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcMethod.getAccessType(), "java.lang.String"));
		csp_18.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgMethod.getAccessType(), "java.lang.String"));
		csp_18.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_19.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcMethod.getName(), "java.lang.String"));
		csp_19.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgMethod.getName(), "java.lang.String"));
		csp_19.solve();
