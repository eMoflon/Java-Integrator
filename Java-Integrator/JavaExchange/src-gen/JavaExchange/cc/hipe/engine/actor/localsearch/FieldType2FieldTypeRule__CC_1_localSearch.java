...
public class FieldType2FieldTypeRule__CC_1_localSearch extends GenericLocalSearchActor{
			...
			case "SimpleField2SimpleField_object": 
				{
					...
					// SF2SF
					HMatch match_0 = new LocalSearchMatch("FieldType2FieldTypeRule__CC_1_localSearch", 5);
			...
			case "SimpleField_object": 
				{
					...
					// srcField
					HMatch match_1 = new LocalSearchMatch("FieldType2FieldTypeRule__CC_1_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgField
					HMatch match_2 = new LocalSearchMatch("FieldType2FieldTypeRule__CC_1_localSearch", 5);
			...
			case "JvmParameterizedTypeReference_object_SP0": 
				{
					...
					// srcRef
					HMatch match_3 = new LocalSearchMatch("FieldType2FieldTypeRule__CC_1_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_5_1_orchestration, match_3);
					
					// trgRef
					HMatch match_4 = new LocalSearchMatch("FieldType2FieldTypeRule__CC_1_localSearch", 5);
		...
		case "SimpleField2SimpleField_source_SimpleField": 
			{
				...
				HMatch match = new LocalSearchMatch("FieldType2FieldTypeRule__CC_1_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
