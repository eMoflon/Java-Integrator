package JavaExchange.cc.hipe.engine.actor.localsearch;
...
public class SimpleField2SimpleFieldRule__CONSISTENCY_98_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClass) o).getTarget();
						edge_explorer = new CachedEdgeExplorer(this, 4, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleField) o).getTarget();
						edge_explorer_3 = new CachedEdgeExplorer(this, 5, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleClass) o).getSimpleFields();
						edge_explorer_4_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleClass) return edge_explorer_4_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_4 = new EdgeExplorer(this, 0, 1, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCONTEXT__SRC__srcClass();
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCONTEXT__CORR__SC2SC();
						edge_explorer_6 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_6_methods);
		name2explorer.put("edge_explorer_6", edge_explorer_6);
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleClass) o).getSimpleFields();
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleClass) return edge_explorer_7_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCREATE__SRC__srcField();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCREATE__TRG__trgField();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCONTEXT__TRG__trgClass();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleField) o).getSource();
			...
			case "SimpleClass_object_SP1": 
				{
					...
					// srcClass
					HMatch match_0 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_98_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_4_1_orchestration, match_0);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_98_localSearch", 7);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_2_orchestration, match_2);
				}
				break;
			case "SimpleField_object": 
				{
					
					// srcField
					HMatch match_1 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_98_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_4_2_orchestration, match_1);
					
					// trgField
					HMatch match_3 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_98_localSearch", 7);
			...
			case "SimpleClass2SimpleClass_object_SP0": 
				{
					...
					// SC2SC
					HMatch match_4 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_98_localSearch", 7);
			...
			case "SimpleField2SimpleField_object": 
				{
					...
					// SF2SF
					HMatch match_5 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_98_localSearch", 7);
			...
			case "SimpleField2SimpleFieldRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_98_localSearch", 7);
		...
		case "SimpleClass2SimpleClass_target_SimpleClass": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_98_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[4] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcField.isIsStatic(), "boolean"));
		csp_12.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgField.isIsStatic(), "boolean"));
		csp_12.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcField.isIsFinal(), "boolean"));
		csp_13.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgField.isIsFinal(), "boolean"));
		csp_13.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcField.getAccessType(), "java.lang.String"));
		csp_14.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgField.getAccessType(), "java.lang.String"));
		csp_14.solve();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcField.getName(), "java.lang.String"));
		csp_15.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgField.getName(), "java.lang.String"));
		csp_15.solve();
