...
public class SimpleClass2SimpleClassRule__CC_78_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimplePackage2SimplePackage) o).getTarget();
						edge_explorer_4 = new CachedEdgeExplorer(this, 0, 2, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimplePackage) o).getSimpleClasses();
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimplePackage) return edge_explorer_5_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleClass2SimpleClassRule__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimplePackage2SimplePackage_object": 
				{
					...
					// SP2SP
					HMatch match_0 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CC_78_localSearch", 5);
			...
			case "SimplePackage_object_SP0": 
				{
					...
					// srcPackage
					HMatch match_1 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CC_78_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_2_orchestration, match_1);
					
					// trgPackage
					HMatch match_2 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CC_78_localSearch", 5);
			...
			case "SimpleClass_object_SP0": 
				{
					...
					// srcClass
					HMatch match_3 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CC_78_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_5_1_orchestration, match_3);
					
					// trgClass
					HMatch match_4 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CC_78_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "SimplePackage_simpleClasses_SimpleClass": 
			{
				HMatch match = new LocalSearchMatch("SimpleClass2SimpleClassRule__CC_78_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.xtext.simplejava.simpleJava.SimpleClass srcClass = (org.xtext.simplejava.simpleJava.SimpleClass) match.getNodes()[3];
		org.xtext.simplejava.simpleJava.SimpleClass trgClass = (org.xtext.simplejava.simpleJava.SimpleClass) match.getNodes()[4];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_6 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcClass.getName(), "java.lang.String"));
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgClass.getName(), "java.lang.String"));
		csp_6.solve();
