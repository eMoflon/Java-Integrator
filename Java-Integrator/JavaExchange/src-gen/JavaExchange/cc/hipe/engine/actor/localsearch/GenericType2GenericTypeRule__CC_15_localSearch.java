...
public class GenericType2GenericTypeRule__CC_15_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType(); return (result instanceof org.eclipse.xtext.common.types.JvmGenericType ? result : null);};
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("GenericType2GenericTypeRule__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "TypeRef2TypeRef_object_SP1": 
				{
					...
					// a2a
					HMatch match_0 = new LocalSearchMatch("GenericType2GenericTypeRule__CC_15_localSearch", 5);
			...
			case "JvmParameterizedTypeReference_object_SP2": 
				{
					...
					// srcRef
					HMatch match_1 = new LocalSearchMatch("GenericType2GenericTypeRule__CC_15_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					edge_explorer_5.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("GenericType2GenericTypeRule__CC_15_localSearch", 5);
			...
			case "JvmGenericType_object": 
				{
					...
					// srcType
					HMatch match_3 = new LocalSearchMatch("GenericType2GenericTypeRule__CC_15_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_4_1_orchestration, match_3);
					
					// trgType
					HMatch match_4 = new LocalSearchMatch("GenericType2GenericTypeRule__CC_15_localSearch", 5);
		...
		case "TypeRef2TypeRef_target_JvmParameterizedTypeReference": 
			{
				...
				HMatch match = new LocalSearchMatch("GenericType2GenericTypeRule__CC_15_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.eclipse.xtext.common.types.JvmGenericType srcType = (org.eclipse.xtext.common.types.JvmGenericType) match.getNodes()[3];
		org.eclipse.xtext.common.types.JvmGenericType trgType = (org.eclipse.xtext.common.types.JvmGenericType) match.getNodes()[4];
