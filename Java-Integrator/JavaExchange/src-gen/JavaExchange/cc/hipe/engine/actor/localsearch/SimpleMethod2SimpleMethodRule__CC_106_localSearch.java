...
public class SimpleMethod2SimpleMethodRule__CC_106_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClass) o).getSource();
						edge_explorer_3 = new CachedEdgeExplorer(this, 0, 1, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleClass) o).getSimpleMethods();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleClass) o).getSimpleMethods();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleMethod2SimpleMethodRule__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimpleClass2SimpleClass_object_SP1": 
				{
					...
					// SC2SC
					HMatch match_0 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CC_106_localSearch", 5);
			...
			case "SimpleClass_object_SP0": 
				{
					...
					// srcClass
					HMatch match_1 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CC_106_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CC_106_localSearch", 5);
			...
			case "SimpleMethod_object": 
				{
					...
					// srcMethod
					HMatch match_3 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CC_106_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_5_1_orchestration, match_3);
					
					// trgMethod
					HMatch match_4 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CC_106_localSearch", 5);
		...
		case "SimpleClass2SimpleClass_target_SimpleClass": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CC_106_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.xtext.simplejava.simpleJava.SimpleMethod srcMethod = (org.xtext.simplejava.simpleJava.SimpleMethod) match.getNodes()[3];
		org.xtext.simplejava.simpleJava.SimpleMethod trgMethod = (org.xtext.simplejava.simpleJava.SimpleMethod) match.getNodes()[4];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_16 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcMethod.getAccessType(), "java.lang.String"));
		csp_16.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgMethod.getAccessType(), "java.lang.String"));
		csp_16.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_17.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcMethod.getName(), "java.lang.String"));
		csp_17.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgMethod.getName(), "java.lang.String"));
		csp_17.solve();
