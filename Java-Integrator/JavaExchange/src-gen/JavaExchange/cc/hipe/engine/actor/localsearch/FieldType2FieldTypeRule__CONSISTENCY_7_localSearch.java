...
public class FieldType2FieldTypeRule__CONSISTENCY_7_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCONTEXT__TRG__trgField();
						edge_explorer = new CachedEdgeExplorer(this, 6, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCREATE__SRC__srcRef();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 1, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCREATE__TRG__trgRef();
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleField) o).getSource();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleField) o).getFieldType();
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleField) return o.equals(edge_explorer_7_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleField) o).getFieldType();
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleField) return o.equals(edge_explorer_8_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCREATE__CORR__TR2TR();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleField) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCONTEXT__SRC__srcField();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((JavaExchange.TypeRef2TypeRef) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCONTEXT__CORR__SF2SF();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("FieldType2FieldTypeRule__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimpleField_object": 
				{
					...
					// srcField
					HMatch match_0 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_7_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_5_2_orchestration, match_0);
					
					// trgField
					HMatch match_2 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_7_localSearch", 7);
			...
			case "JvmParameterizedTypeReference_object_SP1": 
				{
					...
					// srcRef
					HMatch match_1 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_7_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// trgRef
					HMatch match_3 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_7_localSearch", 7);
			...
			case "SimpleField2SimpleField_object": 
				{
					...
					// SF2SF
					HMatch match_4 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_7_localSearch", 7);
			...
			case "TypeRef2TypeRef_object_SP0": 
				{
					...
					// TR2TR
					HMatch match_5 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_7_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_6_1_orchestration, match_5);
				}
				break;
			case "FieldType2FieldTypeRule__Marker_object": 
				{
					...
					// FieldType2FieldTypeRule_eMoflon_ProtocolNode
					HMatch match_6 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_7_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "FieldType2FieldTypeRule__Marker_CONTEXT__TRG__trgField_SimpleField": 
			{
				edge_explorer.registerEdge(msg.source, msg.target);
				HMatch match = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_7_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[6] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
			...
			break;
		case "FieldType2FieldTypeRule__Marker_CREATE__SRC__srcRef_JvmParameterizedTypeReference": 
			{
			...
			break;
		case "FieldType2FieldTypeRule__Marker_CREATE__TRG__trgRef_JvmParameterizedTypeReference": 
			{
		...
		case "TypeRef2TypeRef_source_JvmParameterizedTypeReference": 
			...
			break;
		case "SimpleField_fieldType_JvmParameterizedTypeReference": 
			{
				HMatch match = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_7_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
			...
			break;
		case "FieldType2FieldTypeRule__Marker_CREATE__CORR__TR2TR_TypeRef2TypeRef": 
			{
		...
		case "SimpleField2SimpleField_target_SimpleField": 
			...
			break;
		case "FieldType2FieldTypeRule__Marker_CONTEXT__SRC__srcField_SimpleField": 
			{
		...
		case "TypeRef2TypeRef_target_JvmParameterizedTypeReference": 
			...
			break;
		case "FieldType2FieldTypeRule__Marker_CONTEXT__CORR__SF2SF_SimpleField2SimpleField": 
			{
	...
	protected void registerMatch(HMatch match) {
		...
		// register FieldType2FieldTypeRule_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister FieldType2FieldTypeRule_eMoflon_ProtocolNode
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
