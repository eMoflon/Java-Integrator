...
public class SimpleClass2SimpleClassRule__CONSISTENCY_84_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimplePackage) o).getSimpleClasses();
						edge_explorer_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimplePackage) return edge_explorer_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer = new EdgeExplorer(this, 3, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClassRule__Marker) o).getCONTEXT__SRC__srcPackage();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClassRule__Marker) o).getCREATE__TRG__trgClass();
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClassRule__Marker) o).getCREATE__CORR__SC2SC();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.SimplePackage2SimplePackage) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClass) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClassRule__Marker) o).getCONTEXT__CORR__SP2SP();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((JavaExchange.SimplePackage2SimplePackage) o).getSource();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimplePackage) o).getSimpleClasses();
						edge_explorer_13_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimplePackage) return edge_explorer_13_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
			...
			case "SimpleClass_object_SP1": 
				{
					...
					// srcClass
					HMatch match_0 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CONSISTENCY_84_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_8_1_orchestration, match_0);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CONSISTENCY_84_localSearch", 7);
			...
			case "SimplePackage_object_SP1": 
				{
					...
					// srcPackage
					HMatch match_1 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CONSISTENCY_84_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_2_orchestration, match_1);
					
					// trgPackage
					HMatch match_3 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CONSISTENCY_84_localSearch", 7);
			...
			case "SimpleClass2SimpleClass_object_SP0": 
				{
					...
					// SC2SC
					HMatch match_4 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CONSISTENCY_84_localSearch", 7);
			...
			case "SimplePackage2SimplePackage_object": 
				{
					...
					// SP2SP
					HMatch match_5 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CONSISTENCY_84_localSearch", 7);
			...
			case "SimpleClass2SimpleClassRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SimpleClass2SimpleClassRule__CONSISTENCY_84_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "SimplePackage_simpleClasses_SimpleClass": 
			{
				HMatch match = new LocalSearchMatch("SimpleClass2SimpleClassRule__CONSISTENCY_84_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[3] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
