...
public class GenericType2GenericTypeRule__CONSISTENCY_21_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getSource(); return (result instanceof org.eclipse.xtext.common.types.JvmGenericType ? result : null);};
						edge_explorer = new CachedEdgeExplorer(this, 5, 1, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getTarget(); return (result instanceof org.eclipse.xtext.common.types.JvmGenericType ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 5, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCONTEXT__SRC__srcRef();
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType(); return (result instanceof org.eclipse.xtext.common.types.JvmGenericType ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCREATE__TRG__trgType();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((JavaExchange.TypeRef2TypeRef) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCREATE__CORR__b2b();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCONTEXT__TRG__trgRef();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCREATE__SRC__srcType();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCONTEXT__CORR__a2a();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> {EObject result = ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType(); return (result instanceof org.eclipse.xtext.common.types.JvmGenericType ? result : null);};
						edge_explorer_13 = new CachedEdgeExplorer(this, 2, 3, edge_explorer_13_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("GenericType2GenericTypeRule__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JvmParameterizedTypeReference_object_SP0": 
				{
					...
					// srcRef
					HMatch match_0 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_21_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_4_2_orchestration, match_0);
					edge_explorer_13.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_21_localSearch", 7);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_8_1_orchestration, match_2);
				}
				break;
			case "JvmGenericType_object": 
				{
					
					// srcType
					HMatch match_1 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_21_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgType
					HMatch match_3 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_21_localSearch", 7);
			...
			case "TypeRef2TypeRef_object_SP0": 
				{
					...
					// a2a
					HMatch match_4 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_21_localSearch", 7);
			...
			case "Type2Type_object": 
				{
					...
					// b2b
					HMatch match_5 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_21_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_1_orchestration, match_5);
				}
				break;
			case "GenericType2GenericTypeRule__Marker_object": 
				{
					...
					// GenericType2GenericTypeRule_eMoflon_ProtocolNode
					HMatch match_6 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_21_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "Type2Type_source_JvmType": 
			if(msg.target instanceof org.eclipse.xtext.common.types.JvmGenericType) {
			{
				edge_explorer.registerEdge(msg.source, msg.target);
				HMatch match = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_21_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
		...
		case "Type2Type_target_JvmType": 
			...
			break;
		case "GenericType2GenericTypeRule__Marker_CONTEXT__SRC__srcRef_JvmParameterizedTypeReference": 
			{
		...
		case "TypeRef2TypeRef_source_JvmParameterizedTypeReference": 
			...
			break;
		case "GenericType2GenericTypeRule__Marker_CREATE__TRG__trgType_JvmGenericType": 
			{
		...
		case "TypeRef2TypeRef_target_JvmParameterizedTypeReference": 
			...
			break;
		case "GenericType2GenericTypeRule__Marker_CREATE__CORR__b2b_Type2Type": 
			{
			...
			break;
		case "GenericType2GenericTypeRule__Marker_CONTEXT__TRG__trgRef_JvmParameterizedTypeReference": 
			{
			...
			break;
		case "GenericType2GenericTypeRule__Marker_CREATE__SRC__srcType_JvmGenericType": 
			{
			...
			break;
		case "GenericType2GenericTypeRule__Marker_CONTEXT__CORR__a2a_TypeRef2TypeRef": 
			{
	...
	protected void registerMatch(HMatch match) {
		...
		// register GenericType2GenericTypeRule_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister GenericType2GenericTypeRule_eMoflon_ProtocolNode
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.eclipse.xtext.common.types.JvmGenericType) {
			HMatch match_1 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_21_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		org.eclipse.xtext.common.types.JvmGenericType srcType = (org.eclipse.xtext.common.types.JvmGenericType) match.getNodes()[1];
		org.eclipse.xtext.common.types.JvmGenericType trgType = (org.eclipse.xtext.common.types.JvmGenericType) match.getNodes()[3];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_2 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcType.getPackageName(), "java.lang.String"));
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgType.getPackageName(), "java.lang.String"));
		csp_2.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_3.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcType.getSimpleName(), "java.lang.String"));
		csp_3.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgType.getSimpleName(), "java.lang.String"));
		csp_3.solve();
