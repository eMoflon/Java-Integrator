...
public class SimpleField2SimpleFieldRule__CC_92_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleClass) o).getSimpleFields();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClass) o).getSource();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleField2SimpleFieldRule__CC_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimpleClass2SimpleClass_object_SP1": 
				{
					...
					// SC2SC
					HMatch match_0 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CC_92_localSearch", 5);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_1_orchestration, match_0);
				}
				break;
			case "SimpleClass_object_SP0": 
				{
					
					// srcClass
					HMatch match_1 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CC_92_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CC_92_localSearch", 5);
			...
			case "SimpleField_object": 
				{
					...
					// srcField
					HMatch match_3 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CC_92_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_3_2_orchestration, match_3);
					
					// trgField
					HMatch match_4 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CC_92_localSearch", 5);
		...
		case "SimpleClass2SimpleClass_target_SimpleClass": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleField2SimpleFieldRule__CC_92_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		org.xtext.simplejava.simpleJava.SimpleField srcField = (org.xtext.simplejava.simpleJava.SimpleField) match.getNodes()[3];
		org.xtext.simplejava.simpleJava.SimpleField trgField = (org.xtext.simplejava.simpleJava.SimpleField) match.getNodes()[4];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_8 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcField.isIsStatic(), "boolean"));
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgField.isIsStatic(), "boolean"));
		csp_8.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcField.isIsFinal(), "boolean"));
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgField.isIsFinal(), "boolean"));
		csp_9.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcField.getAccessType(), "java.lang.String"));
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgField.getAccessType(), "java.lang.String"));
		csp_10.solve();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcField.getName(), "java.lang.String"));
		csp_11.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgField.getName(), "java.lang.String"));
		csp_11.solve();
