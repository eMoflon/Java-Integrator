...
public class SimplePackage2SimplePackageRule__CONSISTENCY_123_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SimplePackage2SimplePackageRule__Marker) o).getCREATE__TRG__trgPackage();
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimplePackage2SimplePackageRule__Marker) o).getCREATE__SRC__srcPackage();
			...
			case "SimplePackage_object_SP0": 
				{
					...
					// srcPackage
					HMatch match_0 = new LocalSearchMatch("SimplePackage2SimplePackageRule__CONSISTENCY_123_localSearch", 4);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_3_2_orchestration, match_0);
					
					// trgPackage
					HMatch match_1 = new LocalSearchMatch("SimplePackage2SimplePackageRule__CONSISTENCY_123_localSearch", 4);
			...
			case "SimplePackage2SimplePackage_object": 
				{
					...
					// SP2SP
					HMatch match_2 = new LocalSearchMatch("SimplePackage2SimplePackageRule__CONSISTENCY_123_localSearch", 4);
			...
			case "SimplePackage2SimplePackageRule__Marker_object": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("SimplePackage2SimplePackageRule__CONSISTENCY_123_localSearch", 4);
		...
		case "SimplePackage2SimplePackageRule__Marker_CREATE__TRG__trgPackage_SimplePackage": 
			{
				...
				HMatch match = new LocalSearchMatch("SimplePackage2SimplePackageRule__CONSISTENCY_123_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[3] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
