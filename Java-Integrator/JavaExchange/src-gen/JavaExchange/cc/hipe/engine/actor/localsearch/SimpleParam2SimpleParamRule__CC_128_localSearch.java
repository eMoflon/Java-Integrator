...
public class SimpleParam2SimpleParamRule__CC_128_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethod) o).getTarget();
						edge_explorer_3 = new CachedEdgeExplorer(this, 0, 2, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleMethod) o).getParams();
						edge_explorer_4_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleMethod) return edge_explorer_4_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
			...
			case "SimpleMethod2SimpleMethod_object": 
				{
					...
					// SM2SM
					HMatch match_0 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CC_128_localSearch", 5);
			...
			case "SimpleMethod_object": 
				{
					...
					// srcMethod
					HMatch match_1 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CC_128_localSearch", 5);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_1_orchestration, match_1);
					
					// trgMethod
					HMatch match_2 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CC_128_localSearch", 5);
			...
			case "SimpleParam_object": 
				{
					...
					// srcParam
					HMatch match_3 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CC_128_localSearch", 5);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_2_orchestration, match_3);
					
					// trgParam
					HMatch match_4 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CC_128_localSearch", 5);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "SimpleMethod_params_SimpleParam": 
			{
				HMatch match = new LocalSearchMatch("SimpleParam2SimpleParamRule__CC_128_localSearch", 5);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
