...
public class SimpleParam2SimpleParamRule__CONSISTENCY_134_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParamRule__Marker) o).getCONTEXT__TRG__trgMethod();
						edge_explorer = new CachedEdgeExplorer(this, 6, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParamRule__Marker) o).getCONTEXT__CORR__SM2SM();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParamRule__Marker) o).getCREATE__CORR__SPa2SPa();
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 5, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParam) o).getSource();
						edge_explorer_5 = new CachedEdgeExplorer(this, 5, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethod) o).getSource();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleMethod) o).getParams();
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleMethod) return edge_explorer_7_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleMethod) o).getParams();
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleMethod) return edge_explorer_8_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						...
						edge_explorer_9 = new CachedEdgeExplorer(this, 4, 2, edge_explorer_9_methods);
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParamRule__Marker) o).getCREATE__SRC__srcParam();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParamRule__Marker) o).getCREATE__TRG__trgParam();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParamRule__Marker) o).getCONTEXT__SRC__srcMethod();
			...
			case "SimpleMethod_object": 
				{
					...
					// srcMethod
					HMatch match_0 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_134_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_6_1_orchestration, match_0);
					
					// trgMethod
					HMatch match_2 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_134_localSearch", 7);
			...
			case "SimpleParam_object": 
				{
					...
					// srcParam
					HMatch match_1 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_134_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_5_1_orchestration, match_1);
					
					// trgParam
					HMatch match_3 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_134_localSearch", 7);
			...
			case "SimpleMethod2SimpleMethod_object": 
				{
					...
					// SM2SM
					HMatch match_4 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_134_localSearch", 7);
			...
			case "SimpleParam2SimpleParam_object": 
				{
					...
					// SPa2SPa
					HMatch match_5 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_134_localSearch", 7);
			...
			case "SimpleParam2SimpleParamRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_134_localSearch", 7);
		...
		case "SimpleParam2SimpleParamRule__Marker_CONTEXT__TRG__trgMethod_SimpleMethod": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleParam2SimpleParamRule__CONSISTENCY_134_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[6] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_23.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcParam.getName(), "java.lang.String"));
		csp_23.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgParam.getName(), "java.lang.String"));
		csp_23.solve();
