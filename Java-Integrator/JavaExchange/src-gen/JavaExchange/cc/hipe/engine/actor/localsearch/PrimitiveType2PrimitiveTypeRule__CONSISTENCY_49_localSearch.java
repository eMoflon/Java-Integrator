...
public class PrimitiveType2PrimitiveTypeRule__CONSISTENCY_49_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCREATE__TRG__trgType();
						edge_explorer = new CachedEdgeExplorer(this, 6, 3, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCONTEXT__CORR__TR2TR();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 5, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> {EObject result = ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
						edge_explorer_4 = new CachedEdgeExplorer(this, 0, 1, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getTarget(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
						edge_explorer_5 = new CachedEdgeExplorer(this, 4, 3, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCREATE__CORR__T2T();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.TypeRef2TypeRef) o).getSource();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCREATE__SRC__srcType();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> {EObject result = ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
						edge_explorer_9 = new CachedEdgeExplorer(this, 2, 3, edge_explorer_9_methods);
		name2explorer.put("edge_explorer_9", edge_explorer_9);
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCONTEXT__TRG__trgRef();
						edge_explorer_10 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getSource(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
						edge_explorer_11 = new CachedEdgeExplorer(this, 4, 1, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCONTEXT__SRC__srcRef();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((JavaExchange.TypeRef2TypeRef) o).getTarget();
						edge_explorer_13 = new CachedEdgeExplorer(this, 5, 2, edge_explorer_13_methods);
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "JvmParameterizedTypeReference_object_SP1": 
				{
					...
					// srcRef
					HMatch match_0 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_49_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_4_1_orchestration, match_0);
					edge_explorer_9.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_49_localSearch", 7);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_9_1_orchestration, match_2);
				}
				break;
			case "JvmPrimitiveType_object": 
				{
					
					// srcType
					HMatch match_1 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_49_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_4_2_orchestration, match_1);
					
					// trgType
					HMatch match_3 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_49_localSearch", 7);
			...
			case "Type2Type_object": 
				{
					...
					// T2T
					HMatch match_4 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_49_localSearch", 7);
			...
			case "TypeRef2TypeRef_object_SP1": 
				{
					...
					// TR2TR
					HMatch match_5 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_49_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_3_1_orchestration, match_5);
				}
				break;
			case "PrimitiveType2PrimitiveTypeRule__Marker_object": 
				{
					...
					// PrimitiveType2PrimitiveTypeRule_eMoflon_ProtocolNode
					HMatch match_6 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_49_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "PrimitiveType2PrimitiveTypeRule__Marker_CREATE__TRG__trgType_JvmPrimitiveType": 
			{
				edge_explorer.registerEdge(msg.source, msg.target);
				HMatch match = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_49_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[6] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
			...
			break;
		case "PrimitiveType2PrimitiveTypeRule__Marker_CONTEXT__CORR__TR2TR_TypeRef2TypeRef": 
			{
		...
		case "JvmParameterizedTypeReference_type_JvmType": 
			if(msg.target instanceof org.eclipse.xtext.common.types.JvmPrimitiveType) {
			{
		...
		case "Type2Type_target_JvmType": 
			...
			break;
		case "PrimitiveType2PrimitiveTypeRule__Marker_CREATE__CORR__T2T_Type2Type": 
			{
		...
		case "TypeRef2TypeRef_source_JvmParameterizedTypeReference": 
			...
			break;
		case "PrimitiveType2PrimitiveTypeRule__Marker_CREATE__SRC__srcType_JvmPrimitiveType": 
			{
			...
			break;
		case "PrimitiveType2PrimitiveTypeRule__Marker_CONTEXT__TRG__trgRef_JvmParameterizedTypeReference": 
			{
		...
		case "Type2Type_source_JvmType": 
			...
			break;
		case "PrimitiveType2PrimitiveTypeRule__Marker_CONTEXT__SRC__srcRef_JvmParameterizedTypeReference": 
			{
	...
	protected void registerMatch(HMatch match) {
		...
		// register PrimitiveType2PrimitiveTypeRule_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister PrimitiveType2PrimitiveTypeRule_eMoflon_ProtocolNode
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.eclipse.xtext.common.types.JvmPrimitiveType) {
			HMatch match_1 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_49_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		org.eclipse.xtext.common.types.JvmPrimitiveType srcType = (org.eclipse.xtext.common.types.JvmPrimitiveType) match.getNodes()[1];
		org.eclipse.xtext.common.types.JvmPrimitiveType trgType = (org.eclipse.xtext.common.types.JvmPrimitiveType) match.getNodes()[3];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_5 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_5.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcType.getSimpleName(), "java.lang.String"));
		csp_5.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgType.getSimpleName(), "java.lang.String"));
		csp_5.solve();
