...
public class ParamType2ParamTypeRule__CONSISTENCY_35_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParam) o).getTarget();
						edge_explorer = new CachedEdgeExplorer(this, 4, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCREATE__CORR__TR2TR();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 5, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParam) o).getSource();
						edge_explorer_4 = new CachedEdgeExplorer(this, 4, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleParam) o).getParamType();
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleParam) return o.equals(edge_explorer_5_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_5 = new EdgeExplorer(this, 0, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCREATE__TRG__trgRef();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleParam) o).getParamType();
						edge_explorer_7_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleParam) return o.equals(edge_explorer_7_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCREATE__SRC__srcRef();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCONTEXT__SRC__srcParam();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCONTEXT__TRG__trgParam();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((JavaExchange.TypeRef2TypeRef) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCONTEXT__CORR__SPa2SPa();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("ParamType2ParamTypeRule__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "SimpleParam_object": 
				{
					
					// srcParam
					HMatch match_0 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_35_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_4_1_orchestration, match_0);
					
					// trgParam
					HMatch match_2 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_35_localSearch", 7);
			...
			case "JvmParameterizedTypeReference_object_SP2": 
				{
					...
					// srcRef
					HMatch match_1 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_35_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_5_1_orchestration, match_1);
					
					// trgRef
					HMatch match_3 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_35_localSearch", 7);
			...
			case "SimpleParam2SimpleParam_object": 
				{
					...
					// SPa2SPa
					HMatch match_4 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_35_localSearch", 7);
			...
			case "TypeRef2TypeRef_object_SP1": 
				{
					...
					// TR2TR
					HMatch match_5 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_35_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_3_2_orchestration, match_5);
				}
				break;
			case "ParamType2ParamTypeRule__Marker_object": 
				{
					...
					// ParamType2ParamTypeRule_eMoflon_ProtocolNode
					HMatch match_6 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_35_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "SimpleParam2SimpleParam_target_SimpleParam": 
			{
				...
				HMatch match = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_35_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[4] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
			...
			break;
		case "ParamType2ParamTypeRule__Marker_CREATE__CORR__TR2TR_TypeRef2TypeRef": 
			{
		...
		case "SimpleParam2SimpleParam_source_SimpleParam": 
			...
			break;
		case "SimpleParam_paramType_JvmParameterizedTypeReference": 
			{
				HMatch match = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_35_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
			...
			break;
		case "ParamType2ParamTypeRule__Marker_CREATE__TRG__trgRef_JvmParameterizedTypeReference": 
			{
			...
			break;
		case "ParamType2ParamTypeRule__Marker_CREATE__SRC__srcRef_JvmParameterizedTypeReference": 
			{
			...
			break;
		case "ParamType2ParamTypeRule__Marker_CONTEXT__SRC__srcParam_SimpleParam": 
			{
			...
			break;
		case "ParamType2ParamTypeRule__Marker_CONTEXT__TRG__trgParam_SimpleParam": 
			{
		...
		case "TypeRef2TypeRef_source_JvmParameterizedTypeReference": 
			...
			break;
		case "ParamType2ParamTypeRule__Marker_CONTEXT__CORR__SPa2SPa_SimpleParam2SimpleParam": 
			{
	...
	protected void registerMatch(HMatch match) {
		...
		// register ParamType2ParamTypeRule_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister ParamType2ParamTypeRule_eMoflon_ProtocolNode
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
