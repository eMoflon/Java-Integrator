...
public class PrimitiveType2PrimitiveTypeRule__CONSISTENCY_60_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
						edge_explorer_3 = new CachedEdgeExplorer(this, 0, 1, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCREATE__TRG__trgType();
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCREATE__CORR__T2T();
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.TypeRef2TypeRef) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getSource(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCONTEXT__CORR__TR2TR();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCONTEXT__TRG__trgRef();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getTarget(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
						edge_explorer_10 = new CachedEdgeExplorer(this, 4, 3, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCONTEXT__SRC__srcRef();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> {EObject result = ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType(); return (result instanceof org.eclipse.xtext.common.types.JvmPrimitiveType ? result : null);};
						edge_explorer_12 = new CachedEdgeExplorer(this, 2, 3, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((JavaExchange.PrimitiveType2PrimitiveTypeRule__Marker) o).getCREATE__SRC__srcType();
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "JvmParameterizedTypeReference_object_SP2": 
				{
					edge_explorer_3.registerSourceObject(objs[0]);
					
					// srcRef
					HMatch match_0 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_60_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_2_orchestration, match_0);
					edge_explorer_12.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_60_localSearch", 7);
			...
			case "JvmPrimitiveType_object": 
				{
					...
					// srcType
					HMatch match_1 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_60_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					
					// trgType
					HMatch match_3 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_60_localSearch", 7);
			...
			case "Type2Type_object_SP1": 
				{
					...
					// T2T
					HMatch match_4 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_60_localSearch", 7);
			...
			case "TypeRef2TypeRef_object_SP0": 
				{
					...
					// TR2TR
					HMatch match_5 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_60_localSearch", 7);
			...
			case "PrimitiveType2PrimitiveTypeRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_60_localSearch", 7);
		...
		case "TypeRef2TypeRef_source_JvmParameterizedTypeReference": 
			{
				...
				HMatch match = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__CONSISTENCY_60_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[5] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcType.getSimpleName(), "java.lang.String"));
		csp_2.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgType.getSimpleName(), "java.lang.String"));
		csp_2.solve();
