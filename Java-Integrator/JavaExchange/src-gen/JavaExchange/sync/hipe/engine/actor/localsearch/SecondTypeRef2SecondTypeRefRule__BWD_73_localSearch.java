...
public class SecondTypeRef2SecondTypeRefRule__BWD_73_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.Type2Type) o).getTarget();
						edge_explorer_4 = new CachedEdgeExplorer(this, 0, 8, edge_explorer_4_methods);
			...
			case "Type2Type_object_SP0": 
				{
					...
					// T2T
					HMatch match_0 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__BWD_73_localSearch", 9);
			...
			case "TypeRef2TypeRef_object_SP2": 
				{
					...
					// TR2TR
					HMatch match_1 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__BWD_73_localSearch", 9);
					...
					// TR2TR2
					HMatch match_2 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__BWD_73_localSearch", 9);
			...
			case "JvmParameterizedTypeReference_object_SP0": 
				{
					...
					// srcRef
					HMatch match_3 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__BWD_73_localSearch", 9);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_7_1_orchestration, match_3);
					
					// srcRef2
					HMatch match_4 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__BWD_73_localSearch", 9);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_8_1_orchestration, match_4);
					edge_explorer_6.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_6 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__BWD_73_localSearch", 9);
					match_6.getNodes()[6] = objs[0];
					start(edge_explorer_5_2_orchestration, match_6);
					edge_explorer.registerSourceObject(objs[0]);
					
					// trgRef2
					HMatch match_7 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__BWD_73_localSearch", 9);
			...
			case "JvmType_object": 
				{
					...
					// srcType
					HMatch match_5 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__BWD_73_localSearch", 9);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_9_1_orchestration, match_5);
					
					// trgType
					HMatch match_8 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__BWD_73_localSearch", 9);
		...
		case "JvmParameterizedTypeReference_type_JvmType": 
			{
				...
				HMatch match = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__BWD_73_localSearch", 9);
				Object[] objs = match.getNodes();
				objs[7] = msg.source;
				objs[8] = msg.target;
				currentDepth++;
