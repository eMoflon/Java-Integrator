...
public class SimpleMethod2SimpleMethodRule__CONSISTENCY_145_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCREATE__SRC__srcMethod();
						edge_explorer = new CachedEdgeExplorer(this, 6, 1, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCREATE__TRG__trgMethod();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCONTEXT__CORR__SC2SC();
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethod) o).getTarget();
						edge_explorer_5 = new CachedEdgeExplorer(this, 5, 3, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCONTEXT__TRG__trgClass();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethod) o).getSource();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleClass) o).getSimpleMethods();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClass) o).getTarget();
						edge_explorer_10 = new CachedEdgeExplorer(this, 4, 2, edge_explorer_10_methods);
		name2explorer.put("edge_explorer_10", edge_explorer_10);
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCREATE__CORR__SM2SM();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleClass) o).getSimpleMethods();
						edge_explorer_12_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleClass) return edge_explorer_12_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_12 = new EdgeExplorer(this, 2, 3, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((JavaExchange.SimpleMethod2SimpleMethodRule__Marker) o).getCONTEXT__SRC__srcClass();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleMethod2SimpleMethodRule__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimpleClass_object_SP1": 
				{
					...
					// srcClass
					HMatch match_0 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_145_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_8_1_orchestration, match_0);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_145_localSearch", 7);
			...
			case "SimpleMethod_object_SP1": 
				{
					...
					// srcMethod
					HMatch match_1 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_145_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgMethod
					HMatch match_3 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_145_localSearch", 7);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_3_1_orchestration, match_3);
				}
				break;
			case "SimpleClass2SimpleClass_object_SP1": 
				{
					edge_explorer_9.registerSourceObject(objs[0]);
					edge_explorer_10.registerSourceObject(objs[0]);
					
					// SC2SC
					HMatch match_4 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_145_localSearch", 7);
			...
			case "SimpleMethod2SimpleMethod_object": 
				{
					...
					// SM2SM
					HMatch match_5 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_145_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_5_1_orchestration, match_5);
				}
				break;
			case "SimpleMethod2SimpleMethodRule__Marker_object": 
				{
					...
					// SimpleMethod2SimpleMethodRule_eMoflon_ProtocolNode
					HMatch match_6 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_145_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "SimpleMethod2SimpleMethodRule__Marker_CREATE__SRC__srcMethod_SimpleMethod": 
			{
				edge_explorer.registerEdge(msg.source, msg.target);
				HMatch match = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_145_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[6] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
			...
			break;
		case "SimpleMethod2SimpleMethodRule__Marker_CREATE__TRG__trgMethod_SimpleMethod": 
			{
			...
			break;
		case "SimpleMethod2SimpleMethodRule__Marker_CONTEXT__CORR__SC2SC_SimpleClass2SimpleClass": 
			{
		...
		case "SimpleMethod2SimpleMethod_target_SimpleMethod": 
			...
			break;
		case "SimpleMethod2SimpleMethodRule__Marker_CONTEXT__TRG__trgClass_SimpleClass": 
			{
		...
		case "SimpleMethod2SimpleMethod_source_SimpleMethod": 
			...
			break;
		case "SimpleClass_simpleMethods_SimpleMethod": 
			{
				HMatch match = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_145_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
		...
		case "SimpleClass2SimpleClass_target_SimpleClass": 
			...
			break;
		case "SimpleMethod2SimpleMethodRule__Marker_CREATE__CORR__SM2SM_SimpleMethod2SimpleMethod": 
			{
			...
			break;
		case "SimpleMethod2SimpleMethodRule__Marker_CONTEXT__SRC__srcClass_SimpleClass": 
			{
	...
	protected void registerMatch(HMatch match) {
		...
		// register SimpleMethod2SimpleMethodRule_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister SimpleMethod2SimpleMethodRule_eMoflon_ProtocolNode
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.xtext.simplejava.simpleJava.SimpleMethod) {
			HMatch match_1 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__CONSISTENCY_145_localSearch", 7);
	...
	public boolean constraint_checker_method(HMatch match) {
		org.xtext.simplejava.simpleJava.SimpleMethod srcMethod = (org.xtext.simplejava.simpleJava.SimpleMethod) match.getNodes()[1];
		org.xtext.simplejava.simpleJava.SimpleMethod trgMethod = (org.xtext.simplejava.simpleJava.SimpleMethod) match.getNodes()[3];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_8 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcMethod.getAccessType(), "java.lang.String"));
		csp_8.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgMethod.getAccessType(), "java.lang.String"));
		csp_8.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcMethod.getName(), "java.lang.String"));
		csp_9.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgMethod.getName(), "java.lang.String"));
		csp_9.solve();
