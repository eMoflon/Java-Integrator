...
public class PrimitiveType2PrimitiveTypeRule__FWD_68_localSearch extends GenericLocalSearchActor{
			...
			case "TypeRef2TypeRef_object_SP1": 
				{
					...
					// TR2TR
					HMatch match_0 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__FWD_68_localSearch", 4);
			...
			case "JvmParameterizedTypeReference_object_SP3": 
				{
					...
					// srcRef
					HMatch match_1 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__FWD_68_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_1_orchestration, match_1);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__FWD_68_localSearch", 4);
			...
			case "JvmPrimitiveType_object": 
				{
					...
					// srcType
					HMatch match_3 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__FWD_68_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "JvmParameterizedTypeReference_type_JvmType": 
			if(msg.target instanceof org.eclipse.xtext.common.types.JvmPrimitiveType) {
			{
				...
				HMatch match = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__FWD_68_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[1] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
