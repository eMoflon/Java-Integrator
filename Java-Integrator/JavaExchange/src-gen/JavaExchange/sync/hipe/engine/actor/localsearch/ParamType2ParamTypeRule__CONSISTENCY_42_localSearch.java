...
public class ParamType2ParamTypeRule__CONSISTENCY_42_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleParam) o).getParamType();
						edge_explorer_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleParam) return o.equals(edge_explorer_methods.unique_lookup.apply(result)) ? result : null; else return null;};
		...
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCONTEXT__TRG__trgParam();
						edge_explorer_4 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParam) o).getTarget();
						edge_explorer_5 = new CachedEdgeExplorer(this, 4, 2, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCONTEXT__CORR__SPa2SPa();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCREATE__CORR__TR2TR();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCREATE__TRG__trgRef();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.TypeRef2TypeRef) o).getSource();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCONTEXT__SRC__srcParam();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((JavaExchange.ParamType2ParamTypeRule__Marker) o).getCREATE__SRC__srcRef();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleParam) o).getParamType();
						edge_explorer_13_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleParam) return o.equals(edge_explorer_13_methods.unique_lookup.apply(result)) ? result : null; else return null;};
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "SimpleParam_object_SP1": 
				{
					
					// srcParam
					HMatch match_0 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_42_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_9_1_orchestration, match_0);
					
					// trgParam
					HMatch match_2 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_42_localSearch", 7);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_1_orchestration, match_2);
				}
				break;
			case "JvmParameterizedTypeReference_object_SP3": 
				{
					
					// srcRef
					HMatch match_1 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_42_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_10_1_orchestration, match_1);
					
					// trgRef
					HMatch match_3 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_42_localSearch", 7);
			...
			case "SimpleParam2SimpleParam_object": 
				{
					...
					// SPa2SPa
					HMatch match_4 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_42_localSearch", 7);
			...
			case "TypeRef2TypeRef_object_SP1": 
				{
					...
					// TR2TR
					HMatch match_5 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_42_localSearch", 7);
			...
			case "ParamType2ParamTypeRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_42_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "SimpleParam_paramType_JvmParameterizedTypeReference": 
			{
				HMatch match = new LocalSearchMatch("ParamType2ParamTypeRule__CONSISTENCY_42_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
