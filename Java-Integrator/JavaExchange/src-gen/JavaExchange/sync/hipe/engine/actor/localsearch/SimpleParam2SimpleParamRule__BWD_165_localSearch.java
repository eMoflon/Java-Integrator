...
public class SimpleParam2SimpleParamRule__BWD_165_localSearch extends GenericLocalSearchActor{
			...
			case "SimpleMethod2SimpleMethod_object": 
				{
					...
					// SM2SM
					HMatch match_0 = new LocalSearchMatch("SimpleParam2SimpleParamRule__BWD_165_localSearch", 4);
			...
			case "SimpleMethod_object_SP1": 
				{
					...
					// srcMethod
					HMatch match_1 = new LocalSearchMatch("SimpleParam2SimpleParamRule__BWD_165_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgMethod
					HMatch match_2 = new LocalSearchMatch("SimpleParam2SimpleParamRule__BWD_165_localSearch", 4);
			...
			case "SimpleParam_object_SP1": 
				{
					...
					// trgParam
					HMatch match_3 = new LocalSearchMatch("SimpleParam2SimpleParamRule__BWD_165_localSearch", 4);
		...
		case "SimpleMethod2SimpleMethod_source_SimpleMethod": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleParam2SimpleParamRule__BWD_165_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
