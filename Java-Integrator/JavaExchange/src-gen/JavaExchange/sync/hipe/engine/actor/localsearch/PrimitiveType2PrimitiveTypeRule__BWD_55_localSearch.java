...
public class PrimitiveType2PrimitiveTypeRule__BWD_55_localSearch extends GenericLocalSearchActor{
			...
			case "TypeRef2TypeRef_object_SP2": 
				{
					...
					// TR2TR
					HMatch match_0 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__BWD_55_localSearch", 4);
			...
			case "JvmParameterizedTypeReference_object_SP1": 
				{
					...
					// srcRef
					HMatch match_1 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__BWD_55_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_1_orchestration, match_1);
					edge_explorer_4.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__BWD_55_localSearch", 4);
			...
			case "JvmPrimitiveType_object": 
				{
					...
					// trgType
					HMatch match_3 = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__BWD_55_localSearch", 4);
		...
		case "TypeRef2TypeRef_target_JvmParameterizedTypeReference": 
			{
				...
				HMatch match = new LocalSearchMatch("PrimitiveType2PrimitiveTypeRule__BWD_55_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
