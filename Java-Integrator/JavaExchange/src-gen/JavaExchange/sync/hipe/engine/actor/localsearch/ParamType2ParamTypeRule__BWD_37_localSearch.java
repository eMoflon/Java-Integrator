...
public class ParamType2ParamTypeRule__BWD_37_localSearch extends GenericLocalSearchActor{
			...
			case "SimpleParam2SimpleParam_object": 
				{
					...
					// SPa2SPa
					HMatch match_0 = new LocalSearchMatch("ParamType2ParamTypeRule__BWD_37_localSearch", 4);
			...
			case "SimpleParam_object_SP0": 
				{
					...
					// srcParam
					HMatch match_1 = new LocalSearchMatch("ParamType2ParamTypeRule__BWD_37_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_2_orchestration, match_1);
					
					// trgParam
					HMatch match_2 = new LocalSearchMatch("ParamType2ParamTypeRule__BWD_37_localSearch", 4);
			...
			case "JvmParameterizedTypeReference_object_SP2": 
				{
					...
					// trgRef
					HMatch match_3 = new LocalSearchMatch("ParamType2ParamTypeRule__BWD_37_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "SimpleParam_paramType_JvmParameterizedTypeReference": 
			{
				HMatch match = new LocalSearchMatch("ParamType2ParamTypeRule__BWD_37_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
