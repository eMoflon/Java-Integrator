...
public class SimpleField2SimpleFieldRule__CONSISTENCY_127_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleClass) o).getSimpleFields();
						edge_explorer_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleClass) return edge_explorer_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer = new EdgeExplorer(this, 0, 1, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCONTEXT__SRC__srcClass();
						edge_explorer_3 = new CachedEdgeExplorer(this, 6, 0, edge_explorer_3_methods);
		name2explorer.put("edge_explorer_3", edge_explorer_3);
		EdgeLookupMethods edge_explorer_4_methods = new EdgeLookupMethods();
						edge_explorer_4_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClass) o).getSource();
						edge_explorer_4 = new CachedEdgeExplorer(this, 4, 0, edge_explorer_4_methods);
		name2explorer.put("edge_explorer_4", edge_explorer_4);
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCONTEXT__CORR__SC2SC();
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 4, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleField) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCREATE__TRG__trgField();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.multi_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleClass) o).getSimpleFields();
						edge_explorer_8_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleClass) return edge_explorer_8_methods.multi_lookup.apply(result).contains(o) ? result : null; else return null;};
						edge_explorer_8 = new EdgeExplorer(this, 2, 3, edge_explorer_8_methods);
		name2explorer.put("edge_explorer_8", edge_explorer_8);
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleField) o).getSource();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCREATE__SRC__srcField();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((JavaExchange.SimpleClass2SimpleClass) o).getTarget();
						edge_explorer_11 = new CachedEdgeExplorer(this, 4, 2, edge_explorer_11_methods);
		name2explorer.put("edge_explorer_11", edge_explorer_11);
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCONTEXT__TRG__trgClass();
						edge_explorer_12 = new CachedEdgeExplorer(this, 6, 2, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleFieldRule__Marker) o).getCREATE__CORR__SF2SF();
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SimpleField2SimpleFieldRule__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
			...
			case "SimpleClass_object_SP1": 
				{
					...
					// srcClass
					HMatch match_0 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_127_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_1_orchestration, match_0);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_127_localSearch", 7);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_8_1_orchestration, match_2);
				}
				break;
			case "SimpleField_object_SP0": 
				{
					
					// srcField
					HMatch match_1 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_127_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgField
					HMatch match_3 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_127_localSearch", 7);
			...
			case "SimpleClass2SimpleClass_object_SP0": 
				{
					...
					// SC2SC
					HMatch match_4 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_127_localSearch", 7);
					match_4.getNodes()[4] = objs[0];
					start(edge_explorer_4_1_orchestration, match_4);
				}
				break;
			case "SimpleField2SimpleField_object": 
				{
					edge_explorer_6.registerSourceObject(objs[0]);
					edge_explorer_9.registerSourceObject(objs[0]);
					
					// SF2SF
					HMatch match_5 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_127_localSearch", 7);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_6_1_orchestration, match_5);
				}
				break;
			case "SimpleField2SimpleFieldRule__Marker_object": 
				{
					...
					// SimpleField2SimpleFieldRule_eMoflon_ProtocolNode
					HMatch match_6 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_127_localSearch", 7);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "SimpleClass_simpleFields_SimpleField": 
			{
				HMatch match = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_127_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
			...
			break;
		case "SimpleField2SimpleFieldRule__Marker_CONTEXT__SRC__srcClass_SimpleClass": 
			{
		...
		case "SimpleClass2SimpleClass_source_SimpleClass": 
			...
			break;
		case "SimpleField2SimpleFieldRule__Marker_CONTEXT__CORR__SC2SC_SimpleClass2SimpleClass": 
			{
			...
			break;
		case "SimpleField2SimpleField_target_SimpleField": 
			{
			...
			break;
		case "SimpleField2SimpleFieldRule__Marker_CREATE__TRG__trgField_SimpleField": 
			{
			...
			break;
		case "SimpleField2SimpleField_source_SimpleField": 
			{
			...
			break;
		case "SimpleField2SimpleFieldRule__Marker_CREATE__SRC__srcField_SimpleField": 
			{
		...
		case "SimpleClass2SimpleClass_target_SimpleClass": 
			...
			break;
		case "SimpleField2SimpleFieldRule__Marker_CONTEXT__TRG__trgClass_SimpleClass": 
			{
			...
			break;
		case "SimpleField2SimpleFieldRule__Marker_CREATE__CORR__SF2SF_SimpleField2SimpleField": 
			{
	...
	protected void registerMatch(HMatch match) {
		...
		// register SimpleField2SimpleFieldRule_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister SimpleField2SimpleFieldRule_eMoflon_ProtocolNode
		Collection<HMatch> matches_6 = obj2matches.get(objs[6]);
		if(matches_6 != null) {
	...
	protected void changeAttribute(AttributeChanged message) {
		...
		if(obj instanceof org.xtext.simplejava.simpleJava.SimpleField) {
			HMatch match_1 = new LocalSearchMatch("SimpleField2SimpleFieldRule__CONSISTENCY_127_localSearch", 7);
			match_1.getNodes()[1] = obj;
			Collection<HMatch> formerMatches_1 = obj2matches.get(obj);
			if(formerMatches_1 != null) {
				
				formerMatches_1 = formerMatches_1.stream().filter(m -> !constraint_checker.check(m) || !constraint_checker_0.check(m) || !constraint_checker_1.check(m) || !constraint_checker_2.check(m)).collect(Collectors.toList());
	...
	public boolean constraint_checker_method(HMatch match) {
		org.xtext.simplejava.simpleJava.SimpleField srcField = (org.xtext.simplejava.simpleJava.SimpleField) match.getNodes()[1];
		org.xtext.simplejava.simpleJava.SimpleField trgField = (org.xtext.simplejava.simpleJava.SimpleField) match.getNodes()[3];
		
		org.emoflon.ibex.tgg.operational.csp.constraints.Eq csp_4 = new org.emoflon.ibex.tgg.operational.csp.constraints.Eq();
		csp_4.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcField.isIsStatic(), "boolean"));
		csp_4.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgField.isIsStatic(), "boolean"));
		csp_4.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_5.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcField.isIsFinal(), "boolean"));
		csp_5.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgField.isIsFinal(), "boolean"));
		csp_5.solve();
	...
	public boolean constraint_checker_1_method(HMatch match) {
		...
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcField.getAccessType(), "java.lang.String"));
		csp_6.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgField.getAccessType(), "java.lang.String"));
		csp_6.solve();
	...
	public boolean constraint_checker_2_method(HMatch match) {
		...
		csp_7.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcField.getName(), "java.lang.String"));
		csp_7.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgField.getName(), "java.lang.String"));
		csp_7.solve();
