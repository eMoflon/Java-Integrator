...
public class ParamType2ParamTypeRule__FWD_50_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SimpleParam2SimpleParam) o).getSource();
			...
			case "SimpleParam2SimpleParam_object": 
				{
					...
					// SPa2SPa
					HMatch match_0 = new LocalSearchMatch("ParamType2ParamTypeRule__FWD_50_localSearch", 4);
			...
			case "SimpleParam_object_SP0": 
				{
					...
					// srcParam
					HMatch match_1 = new LocalSearchMatch("ParamType2ParamTypeRule__FWD_50_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgParam
					HMatch match_2 = new LocalSearchMatch("ParamType2ParamTypeRule__FWD_50_localSearch", 4);
			...
			case "JvmParameterizedTypeReference_object_SP0": 
				{
					...
					// srcRef
					HMatch match_3 = new LocalSearchMatch("ParamType2ParamTypeRule__FWD_50_localSearch", 4);
		...
		case "SimpleParam2SimpleParam_source_SimpleParam": 
			{
				...
				HMatch match = new LocalSearchMatch("ParamType2ParamTypeRule__FWD_50_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
