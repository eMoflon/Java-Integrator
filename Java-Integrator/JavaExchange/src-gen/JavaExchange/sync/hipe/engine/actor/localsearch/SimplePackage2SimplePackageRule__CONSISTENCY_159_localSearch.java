...
public class SimplePackage2SimplePackageRule__CONSISTENCY_159_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SimplePackage2SimplePackageRule__Marker) o).getCREATE__SRC__srcPackage();
						edge_explorer = new CachedEdgeExplorer(this, 3, 0, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.SimplePackage2SimplePackageRule__Marker) o).getCREATE__CORR__SP2SP();
		...
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SimplePackage2SimplePackageRule__Marker) o).getCREATE__TRG__trgPackage();
			...
			case "SimplePackage_object_SP0": 
				{
					...
					// srcPackage
					HMatch match_0 = new LocalSearchMatch("SimplePackage2SimplePackageRule__CONSISTENCY_159_localSearch", 4);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_2_orchestration, match_0);
					
					// trgPackage
					HMatch match_1 = new LocalSearchMatch("SimplePackage2SimplePackageRule__CONSISTENCY_159_localSearch", 4);
			...
			case "SimplePackage2SimplePackage_object": 
				{
					...
					// SP2SP
					HMatch match_2 = new LocalSearchMatch("SimplePackage2SimplePackageRule__CONSISTENCY_159_localSearch", 4);
			...
			case "SimplePackage2SimplePackageRule__Marker_object": 
				{
					...
					HMatch match_3 = new LocalSearchMatch("SimplePackage2SimplePackageRule__CONSISTENCY_159_localSearch", 4);
		...
		case "SimplePackage2SimplePackageRule__Marker_CREATE__SRC__srcPackage_SimplePackage": 
			{
				...
				HMatch match = new LocalSearchMatch("SimplePackage2SimplePackageRule__CONSISTENCY_159_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[3] = msg.source;
				objs[0] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcPackage.getName(), "java.lang.String"));
		csp_10.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgPackage.getName(), "java.lang.String"));
		csp_10.solve();
