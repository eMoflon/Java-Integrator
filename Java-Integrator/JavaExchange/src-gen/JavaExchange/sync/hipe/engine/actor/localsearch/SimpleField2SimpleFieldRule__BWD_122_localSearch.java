...
public class SimpleField2SimpleFieldRule__BWD_122_localSearch extends GenericLocalSearchActor{
			...
			case "SimpleClass2SimpleClass_object_SP1": 
				{
					...
					// SC2SC
					HMatch match_0 = new LocalSearchMatch("SimpleField2SimpleFieldRule__BWD_122_localSearch", 4);
			...
			case "SimpleClass_object_SP0": 
				{
					...
					// srcClass
					HMatch match_1 = new LocalSearchMatch("SimpleField2SimpleFieldRule__BWD_122_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_3_2_orchestration, match_1);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleField2SimpleFieldRule__BWD_122_localSearch", 4);
			...
			case "SimpleField_object_SP1": 
				{
					...
					// trgField
					HMatch match_3 = new LocalSearchMatch("SimpleField2SimpleFieldRule__BWD_122_localSearch", 4);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		case "SimpleClass_simpleFields_SimpleField": 
			{
				HMatch match = new LocalSearchMatch("SimpleField2SimpleFieldRule__BWD_122_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[2] = msg.source;
				objs[3] = msg.target;
				currentDepth++;
