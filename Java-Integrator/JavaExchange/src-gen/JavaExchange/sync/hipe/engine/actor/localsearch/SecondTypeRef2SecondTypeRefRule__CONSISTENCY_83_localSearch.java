...
public class SecondTypeRef2SecondTypeRefRule__CONSISTENCY_83_localSearch extends GenericLocalSearchActor{
	...
	SearchOrchestration edge_explorer_14_2_orchestration;
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__TRG__trgRef2();
						edge_explorer = new CachedEdgeExplorer(this, 9, 4, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.TypeRef2TypeRef) o).getSource();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.TypeRef2TypeRef) o).getSource();
						edge_explorer_5 = new CachedEdgeExplorer(this, 8, 1, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__SRC__srcRef2();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType();
						edge_explorer_7 = new CachedEdgeExplorer(this, 4, 5, edge_explorer_7_methods);
		name2explorer.put("edge_explorer_7", edge_explorer_7);
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__CORR__TR2TR2();
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__SRC__srcRef();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__CORR__TR2TR();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__TRG__trgRef();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType();
						edge_explorer_12 = new CachedEdgeExplorer(this, 3, 5, edge_explorer_12_methods);
		name2explorer.put("edge_explorer_12", edge_explorer_12);
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__TRG__trgType();
		...
		EdgeLookupMethods edge_explorer_14_methods = new EdgeLookupMethods();
						edge_explorer_14_methods.unique_lookup = (o) -> ((JavaExchange.Type2Type) o).getSource();
		...
		EdgeLookupMethods edge_explorer_15_methods = new EdgeLookupMethods();
						edge_explorer_15_methods.unique_lookup = (o) -> ((JavaExchange.Type2Type) o).getTarget();
						edge_explorer_15 = new CachedEdgeExplorer(this, 6, 5, edge_explorer_15_methods);
		name2explorer.put("edge_explorer_15", edge_explorer_15);
		EdgeLookupMethods edge_explorer_16_methods = new EdgeLookupMethods();
						edge_explorer_16_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__SRC__srcType();
						edge_explorer_16 = new CachedEdgeExplorer(this, 9, 2, edge_explorer_16_methods);
		name2explorer.put("edge_explorer_16", edge_explorer_16);
		EdgeLookupMethods edge_explorer_17_methods = new EdgeLookupMethods();
						edge_explorer_17_methods.unique_lookup = (o) -> ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType();
						edge_explorer_17 = new CachedEdgeExplorer(this, 0, 2, edge_explorer_17_methods);
		name2explorer.put("edge_explorer_17", edge_explorer_17);
		EdgeLookupMethods edge_explorer_18_methods = new EdgeLookupMethods();
						edge_explorer_18_methods.unique_lookup = (o) -> ((JavaExchange.TypeRef2TypeRef) o).getTarget();
		...
		EdgeLookupMethods edge_explorer_19_methods = new EdgeLookupMethods();
						edge_explorer_19_methods.unique_lookup = (o) -> ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType();
						edge_explorer_19 = new CachedEdgeExplorer(this, 1, 2, edge_explorer_19_methods);
		name2explorer.put("edge_explorer_19", edge_explorer_19);
		EdgeLookupMethods edge_explorer_20_methods = new EdgeLookupMethods();
						edge_explorer_20_methods.unique_lookup = (o) -> ((JavaExchange.SecondTypeRef2SecondTypeRefRule__Marker) o).getCONTEXT__CORR__T2T();
	...
	protected void initializeOrchestration() {
		...
		edge_explorer_14_2_orchestration = initializeOrchestration(node.getOrchestrations().get(22).getPlan());
	...
	protected void initializePorts(Map<String, ActorRef> name2actor) {
		...
		ports.add(new PortJunction(node.getPorts().getPort().get(0), getSelf(), name2actor.get("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_production"), this::returnTrue , 0  , false ));
	}
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "JvmParameterizedTypeReference_object_SP1": 
				{
					edge_explorer_17.registerSourceObject(objs[0]);
					
					// srcRef
					HMatch match_0 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_83_localSearch", 10);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_3_2_orchestration, match_0);
					edge_explorer_19.registerSourceObject(objs[0]);
					
					// srcRef2
					HMatch match_1 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_83_localSearch", 10);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_5_2_orchestration, match_1);
					edge_explorer_12.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_3 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_83_localSearch", 10);
					match_3.getNodes()[3] = objs[0];
					start(edge_explorer_4_1_orchestration, match_3);
					edge_explorer_7.registerSourceObject(objs[0]);
					
					// trgRef2
					HMatch match_4 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_83_localSearch", 10);
			...
			case "JvmType_object": 
				{
					...
					// srcType
					HMatch match_2 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_83_localSearch", 10);
					match_2.getNodes()[2] = objs[0];
					start(edge_explorer_14_2_orchestration, match_2);
					
					// trgType
					HMatch match_5 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_83_localSearch", 10);
					match_5.getNodes()[5] = objs[0];
					start(edge_explorer_7_1_orchestration, match_5);
				}
				break;
			case "Type2Type_object_SP1": 
				{
					edge_explorer_14.registerSourceObject(objs[0]);
					edge_explorer_15.registerSourceObject(objs[0]);
					
					// T2T
					HMatch match_6 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_83_localSearch", 10);
			...
			case "TypeRef2TypeRef_object_SP0": 
				{
					...
					// TR2TR
					HMatch match_7 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_83_localSearch", 10);
					...
					// TR2TR2
					HMatch match_8 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_83_localSearch", 10);
					match_8.getNodes()[8] = objs[0];
					start(edge_explorer_5_1_orchestration, match_8);
				}
				break;
			case "SecondTypeRef2SecondTypeRefRule__Marker_object": 
				{
					...
					// SecondTypeRef2SecondTypeRefRule_eMoflon_ProtocolNode
					HMatch match_9 = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_83_localSearch", 10);
	...
	protected void addReference(ReferenceAdded msg) {
		...
		switch(msg.refName) {
		case "SecondTypeRef2SecondTypeRefRule__Marker_CONTEXT__TRG__trgRef2_JvmParameterizedTypeReference": 
			{
				edge_explorer.registerEdge(msg.source, msg.target);
				HMatch match = new LocalSearchMatch("SecondTypeRef2SecondTypeRefRule__CONSISTENCY_83_localSearch", 10);
				Object[] objs = match.getNodes();
				objs[9] = msg.source;
				objs[4] = msg.target;
				currentDepth++;
		...
		case "TypeRef2TypeRef_target_JvmParameterizedTypeReference": 
			...
			break;
		case "SecondTypeRef2SecondTypeRefRule__Marker_CONTEXT__SRC__srcRef2_JvmParameterizedTypeReference": 
			{
		...
		case "JvmParameterizedTypeReference_type_JvmType": 
			...
			break;
		case "SecondTypeRef2SecondTypeRefRule__Marker_CONTEXT__CORR__TR2TR2_TypeRef2TypeRef": 
			{
			...
			break;
		case "SecondTypeRef2SecondTypeRefRule__Marker_CONTEXT__SRC__srcRef_JvmParameterizedTypeReference": 
			{
			...
			break;
		case "SecondTypeRef2SecondTypeRefRule__Marker_CONTEXT__CORR__TR2TR_TypeRef2TypeRef": 
			{
			...
			break;
		case "SecondTypeRef2SecondTypeRefRule__Marker_CONTEXT__TRG__trgRef_JvmParameterizedTypeReference": 
			{
			...
			break;
		case "SecondTypeRef2SecondTypeRefRule__Marker_CONTEXT__TRG__trgType_JvmType": 
			{
		...
		case "Type2Type_target_JvmType": 
			...
			break;
		case "SecondTypeRef2SecondTypeRefRule__Marker_CONTEXT__SRC__srcType_JvmType": 
			{
			...
			break;
		case "SecondTypeRef2SecondTypeRefRule__Marker_CONTEXT__CORR__T2T_Type2Type": 
			{
	...
	protected void registerMatch(HMatch match) {
		...
		// register SecondTypeRef2SecondTypeRefRule_eMoflon_ProtocolNode
	...
	protected void deregisterMatch(HMatch match) {
		...
		// deregister SecondTypeRef2SecondTypeRefRule_eMoflon_ProtocolNode
		Collection<HMatch> matches_9 = obj2matches.get(objs[9]);
		if(matches_9 != null) {
