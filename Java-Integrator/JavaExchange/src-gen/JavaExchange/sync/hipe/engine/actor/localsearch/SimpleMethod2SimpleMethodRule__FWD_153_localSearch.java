...
public class SimpleMethod2SimpleMethodRule__FWD_153_localSearch extends GenericLocalSearchActor{
			...
			case "SimpleClass2SimpleClass_object_SP0": 
				{
					...
					// SC2SC
					HMatch match_0 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__FWD_153_localSearch", 4);
			...
			case "SimpleClass_object_SP2": 
				{
					...
					// srcClass
					HMatch match_1 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__FWD_153_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgClass
					HMatch match_2 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__FWD_153_localSearch", 4);
			...
			case "SimpleMethod_object_SP0": 
				{
					...
					// srcMethod
					HMatch match_3 = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__FWD_153_localSearch", 4);
		...
		case "SimpleClass2SimpleClass_source_SimpleClass": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleMethod2SimpleMethodRule__FWD_153_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
