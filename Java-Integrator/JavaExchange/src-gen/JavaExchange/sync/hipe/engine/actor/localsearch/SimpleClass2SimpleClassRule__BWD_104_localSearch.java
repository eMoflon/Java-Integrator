...
public class SimpleClass2SimpleClassRule__BWD_104_localSearch extends GenericLocalSearchActor{
			...
			case "SimplePackage2SimplePackage_object": 
				{
					...
					// SP2SP
					HMatch match_0 = new LocalSearchMatch("SimpleClass2SimpleClassRule__BWD_104_localSearch", 4);
			...
			case "SimplePackage_object_SP0": 
				{
					...
					// srcPackage
					HMatch match_1 = new LocalSearchMatch("SimpleClass2SimpleClassRule__BWD_104_localSearch", 4);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_2_orchestration, match_1);
					
					// trgPackage
					HMatch match_2 = new LocalSearchMatch("SimpleClass2SimpleClassRule__BWD_104_localSearch", 4);
			...
			case "SimpleClass_object_SP0": 
				{
					...
					// trgClass
					HMatch match_3 = new LocalSearchMatch("SimpleClass2SimpleClassRule__BWD_104_localSearch", 4);
		...
		case "SimplePackage2SimplePackage_source_SimplePackage": 
			{
				...
				HMatch match = new LocalSearchMatch("SimpleClass2SimpleClassRule__BWD_104_localSearch", 4);
				Object[] objs = match.getNodes();
				objs[0] = msg.source;
				objs[1] = msg.target;
				currentDepth++;
