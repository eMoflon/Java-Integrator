...
public class FieldType2FieldTypeRule__CONSISTENCY_6_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_methods = new EdgeLookupMethods();
						edge_explorer_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleField) o).getTarget();
						edge_explorer = new CachedEdgeExplorer(this, 4, 2, edge_explorer_methods);
		name2explorer.put("edge_explorer", edge_explorer);
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCONTEXT__SRC__srcField();
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleField) o).getFieldType();
						edge_explorer_5_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleField) return o.equals(edge_explorer_5_methods.unique_lookup.apply(result)) ? result : null; else return null;};
						edge_explorer_5 = new EdgeExplorer(this, 2, 3, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCREATE__SRC__srcRef();
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCREATE__CORR__TR2TR();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.SimpleField2SimpleField) o).getSource();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCONTEXT__CORR__SF2SF();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((JavaExchange.FieldType2FieldTypeRule__Marker) o).getCONTEXT__TRG__trgField();
		...
		EdgeLookupMethods edge_explorer_13_methods = new EdgeLookupMethods();
						edge_explorer_13_methods.unique_lookup = (o) -> ((org.xtext.simplejava.simpleJava.SimpleField) o).getFieldType();
						edge_explorer_13_methods.unique_opposite_lookup = (o) -> {EObject result = ((EObject) o).eContainer(); if(result instanceof org.xtext.simplejava.simpleJava.SimpleField) return o.equals(edge_explorer_13_methods.unique_lookup.apply(result)) ? result : null; else return null;};
	...
	protected void added(MatchAdded<HMatch> msg) {
		...
		switch(match.creator) {
			case "SimpleField_object_SP1": 
				{
					
					// srcField
					HMatch match_0 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_6_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_3_2_orchestration, match_0);
					
					// trgField
					HMatch match_2 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_6_localSearch", 7);
			...
			case "JvmParameterizedTypeReference_object_SP1": 
				{
					...
					// srcRef
					HMatch match_1 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_6_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_6_1_orchestration, match_1);
					
					// trgRef
					HMatch match_3 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_6_localSearch", 7);
			...
			case "SimpleField2SimpleField_object": 
				{
					...
					// SF2SF
					HMatch match_4 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_6_localSearch", 7);
			...
			case "TypeRef2TypeRef_object_SP0": 
				{
					...
					// TR2TR
					HMatch match_5 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_6_localSearch", 7);
			...
			case "FieldType2FieldTypeRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_6_localSearch", 7);
		...
		case "SimpleField2SimpleField_target_SimpleField": 
			{
				...
				HMatch match = new LocalSearchMatch("FieldType2FieldTypeRule__CONSISTENCY_6_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[4] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
