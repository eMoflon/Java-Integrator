...
public class GenericType2GenericTypeRule__CONSISTENCY_24_localSearch extends GenericLocalSearchActor{
	...
	protected void initializeSearchComponents() {
		...
		EdgeLookupMethods edge_explorer_3_methods = new EdgeLookupMethods();
						edge_explorer_3_methods.unique_lookup = (o) -> {EObject result = ((org.eclipse.xtext.common.types.JvmParameterizedTypeReference) o).getType(); return (result instanceof org.eclipse.xtext.common.types.JvmGenericType ? result : null);};
		...
		EdgeLookupMethods edge_explorer_5_methods = new EdgeLookupMethods();
						edge_explorer_5_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCREATE__TRG__trgType();
						edge_explorer_5 = new CachedEdgeExplorer(this, 6, 3, edge_explorer_5_methods);
		name2explorer.put("edge_explorer_5", edge_explorer_5);
		EdgeLookupMethods edge_explorer_6_methods = new EdgeLookupMethods();
						edge_explorer_6_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getTarget(); return (result instanceof org.eclipse.xtext.common.types.JvmGenericType ? result : null);};
		...
		EdgeLookupMethods edge_explorer_7_methods = new EdgeLookupMethods();
						edge_explorer_7_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCREATE__SRC__srcType();
		...
		EdgeLookupMethods edge_explorer_8_methods = new EdgeLookupMethods();
						edge_explorer_8_methods.unique_lookup = (o) -> {EObject result = ((JavaExchange.Type2Type) o).getSource(); return (result instanceof org.eclipse.xtext.common.types.JvmGenericType ? result : null);};
		...
		EdgeLookupMethods edge_explorer_9_methods = new EdgeLookupMethods();
						edge_explorer_9_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCONTEXT__TRG__trgRef();
		...
		EdgeLookupMethods edge_explorer_10_methods = new EdgeLookupMethods();
						edge_explorer_10_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCONTEXT__CORR__a2a();
		...
		EdgeLookupMethods edge_explorer_11_methods = new EdgeLookupMethods();
						edge_explorer_11_methods.unique_lookup = (o) -> ((JavaExchange.GenericType2GenericTypeRule__Marker) o).getCREATE__CORR__b2b();
		...
		EdgeLookupMethods edge_explorer_12_methods = new EdgeLookupMethods();
						edge_explorer_12_methods.unique_lookup = (o) -> ((JavaExchange.TypeRef2TypeRef) o).getSource();
						edge_explorer_12 = new CachedEdgeExplorer(this, 4, 0, edge_explorer_12_methods);
			...
			case "JvmParameterizedTypeReference_object_SP0": 
				{
					...
					// srcRef
					HMatch match_0 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_24_localSearch", 7);
					match_0.getNodes()[0] = objs[0];
					start(edge_explorer_4_2_orchestration, match_0);
					edge_explorer_3.registerSourceObject(objs[0]);
					
					// trgRef
					HMatch match_2 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_24_localSearch", 7);
			...
			case "JvmGenericType_object": 
				{
					...
					// srcType
					HMatch match_1 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_24_localSearch", 7);
					match_1.getNodes()[1] = objs[0];
					start(edge_explorer_7_1_orchestration, match_1);
					
					// trgType
					HMatch match_3 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_24_localSearch", 7);
			...
			case "TypeRef2TypeRef_object_SP2": 
				{
					...
					// a2a
					HMatch match_4 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_24_localSearch", 7);
			...
			case "Type2Type_object_SP0": 
				{
					...
					// b2b
					HMatch match_5 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_24_localSearch", 7);
			...
			case "GenericType2GenericTypeRule__Marker_object": 
				{
					...
					HMatch match_6 = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_24_localSearch", 7);
		...
		case "TypeRef2TypeRef_target_JvmParameterizedTypeReference": 
			{
				...
				HMatch match = new LocalSearchMatch("GenericType2GenericTypeRule__CONSISTENCY_24_localSearch", 7);
				Object[] objs = match.getNodes();
				objs[4] = msg.source;
				objs[2] = msg.target;
				currentDepth++;
	...
	public boolean constraint_checker_method(HMatch match) {
		...
		csp_0.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcType.getPackageName(), "java.lang.String"));
		csp_0.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgType.getPackageName(), "java.lang.String"));
		csp_0.solve();
	...
	public boolean constraint_checker_0_method(HMatch match) {
		...
		csp_1.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, srcType.getSimpleName(), "java.lang.String"));
		csp_1.getVariables().add(new org.emoflon.ibex.tgg.operational.csp.RuntimeTGGAttributeConstraintVariable(true, trgType.getSimpleName(), "java.lang.String"));
		csp_1.solve();
