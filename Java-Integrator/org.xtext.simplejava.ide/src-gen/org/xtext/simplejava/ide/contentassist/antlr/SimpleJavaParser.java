 ...
 */
package org.xtext.simplejava.ide.contentassist.antlr;
...
import org.xtext.simplejava.ide.contentassist.antlr.internal.InternalSimpleJavaParser;
...
public class SimpleJavaParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(SimpleJavaGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SimpleJavaGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSimplePackageAccess().getGroup(), "rule__SimplePackage__Group__0");
			builder.put(grammarAccess.getSimpleClassAccess().getGroup(), "rule__SimpleClass__Group__0");
			builder.put(grammarAccess.getSimpleFieldAccess().getGroup(), "rule__SimpleField__Group__0");
			builder.put(grammarAccess.getSimpleMethodAccess().getGroup(), "rule__SimpleMethod__Group__0");
			builder.put(grammarAccess.getSimpleMethodAccess().getGroup_4(), "rule__SimpleMethod__Group_4__0");
			builder.put(grammarAccess.getSimpleMethodAccess().getGroup_4_1(), "rule__SimpleMethod__Group_4_1__0");
			builder.put(grammarAccess.getSimpleParamAccess().getGroup(), "rule__SimpleParam__Group__0");
			...
			builder.put(grammarAccess.getSimplePackageAccess().getNameAssignment_1(), "rule__SimplePackage__NameAssignment_1");
			builder.put(grammarAccess.getSimplePackageAccess().getSimpleClassesAssignment_3(), "rule__SimplePackage__SimpleClassesAssignment_3");
			builder.put(grammarAccess.getSimpleClassAccess().getNameAssignment_2(), "rule__SimpleClass__NameAssignment_2");
			builder.put(grammarAccess.getSimpleClassAccess().getSimpleFieldsAssignment_4(), "rule__SimpleClass__SimpleFieldsAssignment_4");
			builder.put(grammarAccess.getSimpleClassAccess().getSimpleMethodsAssignment_5(), "rule__SimpleClass__SimpleMethodsAssignment_5");
			builder.put(grammarAccess.getSimpleFieldAccess().getAccessTypeAssignment_0(), "rule__SimpleField__AccessTypeAssignment_0");
			builder.put(grammarAccess.getSimpleFieldAccess().getIsStaticAssignment_1(), "rule__SimpleField__IsStaticAssignment_1");
			builder.put(grammarAccess.getSimpleFieldAccess().getIsFinalAssignment_2(), "rule__SimpleField__IsFinalAssignment_2");
			builder.put(grammarAccess.getSimpleFieldAccess().getFieldTypeAssignment_3(), "rule__SimpleField__FieldTypeAssignment_3");
			builder.put(grammarAccess.getSimpleFieldAccess().getNameAssignment_4(), "rule__SimpleField__NameAssignment_4");
			builder.put(grammarAccess.getSimpleMethodAccess().getAccessTypeAssignment_0(), "rule__SimpleMethod__AccessTypeAssignment_0");
			builder.put(grammarAccess.getSimpleMethodAccess().getNameAssignment_2(), "rule__SimpleMethod__NameAssignment_2");
			builder.put(grammarAccess.getSimpleMethodAccess().getParamsAssignment_4_0(), "rule__SimpleMethod__ParamsAssignment_4_0");
			builder.put(grammarAccess.getSimpleMethodAccess().getParamsAssignment_4_1_1(), "rule__SimpleMethod__ParamsAssignment_4_1_1");
			builder.put(grammarAccess.getSimpleParamAccess().getParamTypeAssignment_0(), "rule__SimpleParam__ParamTypeAssignment_0");
			builder.put(grammarAccess.getSimpleParamAccess().getNameAssignment_1(), "rule__SimpleParam__NameAssignment_1");
